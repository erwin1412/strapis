...
import { useFocusWhenNavigate, useNotification, useRBAC, useTracking, useGuidedTour, useFetchClient, SettingsPageTitle, LinkButton, NoPermissions, NoContent, CheckPagePermissions } from "@strapi/helper-plugin";
...
const ProtectedTransferTokenListView = () => {
  const permissions = useSelector(selectAdminPermissions);
  return /* @__PURE__ */ jsx(CheckPagePermissions, { permissions: permissions.settings["transfer-tokens"].main, children: /* @__PURE__ */ jsx(TransferTokenListView, {}) });
};
export {
  ProtectedTransferTokenListView as default
};
//# sourceMappingURL=index-fb6f634d.mjs.map
