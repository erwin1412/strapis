...
const AuthPage = ({ hasAdmin }) => {
  ...
  const Login$1 = useEnterprise(
    Login,
    async () => (await import("./Login-54110b81.mjs")).LoginEE
  );
  const forms = useEnterprise(
    FORMS,
    async () => (await import("./constants-89ae95c6.mjs")).FORMS,
    {
...
const AuthenticatedApp = React.lazy(
  () => import("./AuthenticatedApp-5524c90a.mjs").then((n) => n.A).then((mod) => ({ default: mod.AuthenticatedApp }))
);
const App = () => {
...
//# sourceMappingURL=index-4c3eb885.mjs.map
