...
const WebhookEventContext = React__namespace.createContext();
const Root = ({ children }) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(WebhookEventContext.Provider, { value: { isDraftAndPublish }, children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { direction: "column", alignItems: "stretch", gap: 1, children: [
...
const Headers = ({ getHeaders = getCEHeaders }) => {
  const { isDraftAndPublish } = React__namespace.useContext(WebhookEventContext);
  const { formatMessage } = reactIntl.useIntl();
...
Headers.propTypes = {
  getHeaders: PropTypes__default.default.func
};
...
Body.propTypes = {
  providedEvents: PropTypes__default.default.object
};
...
EventRow.propTypes = {
  disabledEvents: PropTypes__default.default.array,
  events: PropTypes__default.default.array,
  inputValue: PropTypes__default.default.array,
  handleSelect: PropTypes__default.default.func,
  handleSelectAll: PropTypes__default.default.func,
  name: PropTypes__default.default.string.isRequired
};
const EventTable = { Root, Headers, Body, EventRow };
function EventTableCE() {
  return /* @__PURE__ */ jsxRuntime.jsxs(EventTable.Root, { children: [
    /* @__PURE__ */ jsxRuntime.jsx(EventTable.Headers, {}),
    /* @__PURE__ */ jsxRuntime.jsx(EventTable.Body, {})
  ] });
}
const HTTP_HEADERS = [
  "A-IM",
      ...
      formik.FieldArray,
      {
        ...
        render: ({ push, remove }) => /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Grid, { gap: 4, children: [
          values.headers.map((header, index2) => (
            ...
            /* @__PURE__ */ jsxRuntime.jsxs(React__namespace.default.Fragment, { children: [
              /* @__PURE__ */ jsxRuntime.jsx(designSystem.GridItem, { col: 6, children: /* @__PURE__ */ jsxRuntime.jsx(
                formik.Field,
                {
                  ...
                  error: errors.headers?.[index2]?.key && errors.headers[index2].key
                }
              ) }),
              /* @__PURE__ */ jsxRuntime.jsx(designSystem.GridItem, { col: 6, children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { alignItems: "flex-end", children: [
                /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { style: { flex: 1 }, children: /* @__PURE__ */ jsxRuntime.jsx(
                  formik.Field,
                  {
                    ...
                    error: errors.headers?.[index2]?.value && errors.headers[index2].value
                  }
                ) }),
                /* @__PURE__ */ jsxRuntime.jsx(
                  designSystem.Flex,
                  {
                    ...
                    paddingTop: errors.headers?.[index2]?.value ? 0 : 5,
...
Status.propTypes = {
  isPending: PropTypes__default.default.bool.isRequired,
...
const CancelButton = ({ onCancel }) => {
  const { formatMessage } = reactIntl.useIntl();
  return /* @__PURE__ */ jsxRuntime.jsx(designSystem.Flex, { justifyContent: "flex-end", children: /* @__PURE__ */ jsxRuntime.jsx("button", { onClick: onCancel, type: "button", children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { gap: 2, alignItems: "center", children: [
    /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { textColor: "neutral400", children: formatMessage({ id: "Settings.webhooks.trigger.cancel", defaultMessage: "cancel" }) }),
    /* @__PURE__ */ jsxRuntime.jsx(Icon, { as: Icons.Cross, color: "neutral400" })
  ] }) }) });
};
CancelButton.propTypes = { onCancel: PropTypes__default.default.func.isRequired };
const TriggerContainer = ({ isPending, onCancel, response }) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { background: "neutral0", padding: 5, shadow: "filterShadow", hasRadius: true, children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Grid, { gap: 4, style: { alignItems: "center" }, children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsx(designSystem.GridItem, { col: 6, children: !isPending ? /* @__PURE__ */ jsxRuntime.jsx(Message, { statusCode, message }) : /* @__PURE__ */ jsxRuntime.jsx(CancelButton, { onCancel }) })
  ] }) });
};
...
TriggerContainer.propTypes = {
  isPending: PropTypes__default.default.bool,
  onCancel: PropTypes__default.default.func,
  response: PropTypes__default.default.object
};
...
const makeWebhookValidationSchema = ({ formatMessage }) => yup__namespace.object().shape({
  ...
  headers: yup__namespace.lazy((array) => {
    let baseSchema = yup__namespace.array();
    if (array.length === 1) {
...
const WebhookForm = ({
  ...
  const EventTable2 = index.useEnterprise(
    EventTableCE,
    async () => (await Promise.resolve().then(() => require("./index-15983380.js"))).EventTableEE
  );
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(formik.FormikProvider, { value: formik$1, children: /* @__PURE__ */ jsxRuntime.jsxs(helperPlugin.Form, { onSubmit: formik$1.handleSubmit, children: [
    /* @__PURE__ */ jsxRuntime.jsx(
      designSystem.HeaderLayout,
      {
        ...
        navigationAction: /* @__PURE__ */ jsxRuntime.jsx(helperPlugin.Link, { startIcon: /* @__PURE__ */ jsxRuntime.jsx(Icons.ArrowLeft, {}), to: "/settings/webhooks", children: formatMessage({
          id: "global.back",
          defaultMessage: "Back"
        }) })
      }
    ...
    /* @__PURE__ */ jsxRuntime.jsx(designSystem.ContentLayout, { children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { direction: "column", alignItems: "stretch", gap: 4, children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { background: "neutral0", padding: 8, shadow: "filterShadow", hasRadius: true, children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { direction: "column", alignItems: "stretch", gap: 6, children: [
        /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Grid, { gap: 6, children: [
          /* @__PURE__ */ jsxRuntime.jsx(designSystem.GridItem, { col: 6, children: /* @__PURE__ */ jsxRuntime.jsx(
            formik.Field,
            {
              as: designSystem.TextInput,
              name: "name",
              error: formik$1?.errors?.name && formik$1.errors.name,
              label: formatMessage({
                id: "global.name",
                defaultMessage: "Name"
              }),
          ...
          /* @__PURE__ */ jsxRuntime.jsx(designSystem.GridItem, { col: 12, children: /* @__PURE__ */ jsxRuntime.jsx(
            formik.Field,
            {
              as: designSystem.TextInput,
              name: "url",
              error: formik$1?.errors?.url && formik$1.errors.url,
              label: formatMessage({
        ...
        /* @__PURE__ */ jsxRuntime.jsx(EventTable2, {})
      ] }) })
    ] }) })
  ] }) });
};
WebhookForm.propTypes = {
  ...
  triggerWebhook: PropTypes__default.default.func.isRequired,
  isCreating: PropTypes__default.default.bool.isRequired,
  isTriggering: PropTypes__default.default.bool.isRequired,
  triggerResponse: PropTypes__default.default.object
};
...
const EditView = () => {
  const {
    params: { id }
  } = reactRouterDom.useRouteMatch("/settings/webhooks/:id");
  ...
  const {
    ...
    mutate
  } = reactQuery.useMutation(() => post(`/admin/webhooks/${id}/trigger`));
...
//# sourceMappingURL=index-10f599c1.js.map
