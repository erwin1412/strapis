...
import { u as useConfiguration, c as createTypedSelector, a as useTypedDispatch, b as useTypedSelector, A as ACTION_SET_APP_RUNTIME_STATUS, d as createRoute, R as RBACProvider, N as NpsSurvey } from "./index-4c3eb885.mjs";
...
const CM = React.lazy(
  ...
  () => import("./index-90ed6722.mjs").then((n) => n.i)
);
const HomePage = React.lazy(
  () => import("./HomePage-af8ae9d9.mjs").then((mod) => ({
    default: mod.HomePage
  }))
);
const InstalledPluginsPage = React.lazy(
  () => import("./InstalledPluginsPage-922ee25b.mjs").then((mod) => ({
    default: mod.ProtectedInstalledPluginsPage
  }))
);
const MarketplacePage = React.lazy(
  () => import("./MarketplacePage-7827f842.mjs").then((mod) => ({ default: mod.ProtectedMarketplacePage }))
);
const NotFoundPage = React.lazy(
  () => import("./index-4c3eb885.mjs").then((n) => n.Y).then(({ NotFoundPage: NotFoundPage2 }) => ({ default: NotFoundPage2 }))
);
...
const ProfilePage = React.lazy(
  () => import("./ProfilePage-51b48d52.mjs").then((mod) => ({
...
const SettingsPage = React.lazy(
  () => (
    // @ts-expect-error – No types, yet.
    import("./index-e0bd1ac1.mjs").then((module) => ({
...
//# sourceMappingURL=AuthenticatedApp-5524c90a.mjs.map
