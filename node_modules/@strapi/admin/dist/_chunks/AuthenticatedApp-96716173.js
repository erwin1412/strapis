...
const CM = React__namespace.lazy(
  ...
  () => Promise.resolve().then(() => require("./index-c7f06c75.js")).then((n) => n.index)
);
const HomePage = React__namespace.lazy(
  () => Promise.resolve().then(() => require("./HomePage-419bfd8c.js")).then((mod) => ({
    default: mod.HomePage
  }))
);
const InstalledPluginsPage = React__namespace.lazy(
  () => Promise.resolve().then(() => require("./InstalledPluginsPage-733c83cc.js")).then((mod) => ({
    default: mod.ProtectedInstalledPluginsPage
  }))
);
const MarketplacePage = React__namespace.lazy(
  () => Promise.resolve().then(() => require("./MarketplacePage-2bb9f6c8.js")).then((mod) => ({ default: mod.ProtectedMarketplacePage }))
);
const NotFoundPage = React__namespace.lazy(
  () => Promise.resolve().then(() => require("./index-83e78ac3.js")).then((n) => n.NotFoundPage).then(({ NotFoundPage: NotFoundPage2 }) => ({ default: NotFoundPage2 }))
);
...
const ProfilePage = React__namespace.lazy(
  () => Promise.resolve().then(() => require("./ProfilePage-034b28a3.js")).then((mod) => ({
...
const SettingsPage = React__namespace.lazy(
  () => (
    // @ts-expect-error – No types, yet.
    Promise.resolve().then(() => require("./index-8e785228.js")).then((module2) => ({
...
//# sourceMappingURL=AuthenticatedApp-96716173.js.map
