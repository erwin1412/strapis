...
const index = require("./index-83e78ac3.js");
...
SettingsNav.propTypes = {
  menu: PropTypes__default.default.array.isRequired
};
const ROUTES_CE = [
  {
    async Component() {
      const component = await Promise.resolve().then(() => require("./index-4b209bd2.js"));
      return component;
    },
    to: "/settings/roles",
    exact: true
  ...
  {
    async Component() {
      const component = await Promise.resolve().then(() => require("./index-17faf42d.js"));
      return component;
    },
  ...
  {
    async Component() {
      const component = await Promise.resolve().then(() => require("./index-9d6849bf.js"));
      return component;
    },
  ...
  {
    async Component() {
      const component = await Promise.resolve().then(() => require("./index-e412fafd.js")).then((n) => n.index);
      return component;
    },
    to: "/settings/users",
    exact: true
  ...
  {
    async Component() {
      const component = await Promise.resolve().then(() => require("./index-906e4561.js"));
      return component;
    },
  ...
  {
    async Component() {
      const component = await Promise.resolve().then(() => require("./index-aa4ede2e.js"));
      return component;
    },
  ...
  {
    async Component() {
      const component = await Promise.resolve().then(() => require("./index-414cde92.js"));
      return component;
    },
  ...
  {
    async Component() {
      const component = await Promise.resolve().then(() => require("./index-09ae6db3.js"));
      return component;
    },
  ...
  {
    async Component() {
      const component = await Promise.resolve().then(() => require("./index-1368779e.js"));
      return component;
    },
  ...
  {
    async Component() {
      const component = await Promise.resolve().then(() => require("./index-fa1850fa.js"));
      return component;
    },
  ...
  {
    async Component() {
      const component = await Promise.resolve().then(() => require("./index-35766285.js"));
      return component;
    },
  ...
  {
    async Component() {
      const component = await Promise.resolve().then(() => require("./index-bf66c659.js"));
      return component;
    },
  ...
  {
    async Component() {
      const component = await Promise.resolve().then(() => require("./index-b171513f.js"));
      return component;
    },
  ...
  {
    async Component() {
      const component = await Promise.resolve().then(() => require("./index-171f253e.js"));
      return component;
    },
  ...
  {
    async Component() {
      const component = await Promise.resolve().then(() => require("./SalesPage-d0cdc1a7.js"));
      return component;
    },
  ...
  {
    async Component() {
      const component = await Promise.resolve().then(() => require("./SalesPage-c5cbb366.js"));
      return component;
    },
  ...
  {
    async Component() {
      const component = await Promise.resolve().then(() => require("./SalesPage-66f9ea32.js"));
      return component;
    },
...
const LogoModalStepper = ({
  ...
  const [{ localImage }, dispatch] = React.useReducer(reducer$2, initialState$2);
  const { formatMessage } = reactIntl.useIntl();
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.ModalLayout, { labelledBy: "modal", onClose: handleCloseModal, children: [
    /* @__PURE__ */ jsxRuntime.jsx(designSystem.ModalHeader, { children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { fontWeight: "bold", as: "h2", id: "modal", children: formatMessage(modalTitle) }) }),
...
LogoModalStepper.propTypes = {
  ...
  currentStep: PropTypes__default.default.string,
  customLogo: PropTypes__default.default.shape({
  ...
  modalTitle: PropTypes__default.default.shape({
    id: PropTypes__default.default.string,
    defaultMessage: PropTypes__default.default.string
  }),
  next: PropTypes__default.default.string,
  onChangeLogo: PropTypes__default.default.func.isRequired,
  prev: PropTypes__default.default.string
};
...
const FromComputerForm = ({ setLocalImage, goTo, next, onClose }) => {
  ...
  const [fileError, setFileError] = React.useState(void 0);
      ...
      /* @__PURE__ */ jsxRuntime.jsxs(
        designSystem.Flex,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { paddingTop: 3, paddingBottom: 5, children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { variant: "delta", as: "span", children: formatMessage({
...
FromComputerForm.propTypes = {
  ...
  setLocalImage: PropTypes__default.default.func.isRequired
};
    ...
    designSystem.TabGroup,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsxs(designSystem.TabPanels, { children: [
          ...
          /* @__PURE__ */ jsxRuntime.jsx(designSystem.TabPanel, { children: /* @__PURE__ */ jsxRuntime.jsx(FromUrlForm, { onClose, setLocalImage, goTo, next }) })
        ] })
      ]
    }
  );
...
const PendingLogoDialog = ({ onClose, asset, prev, next, goTo, setLocalImage, onChangeLogo }) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
    /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Box, { paddingLeft: 8, paddingRight: 8, paddingTop: 6, paddingBottom: 6, children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { maxWidth: helperPlugin.pxToRem(180), children: asset.url ? /* @__PURE__ */ jsxRuntime.jsx(ImageCardAsset, { asset }) : null })
    ] }),
    /* @__PURE__ */ jsxRuntime.jsx(
      designSystem.ModalFooter,
      {
...
const LogoInput = ({
  ...
  const [{ currentStep }, dispatch] = React.useReducer(reducer$1, initialState$1);
    ...
    /* @__PURE__ */ jsxRuntime.jsx(
      designSystem.CarouselInput,
      {
        ...
        actions: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.CarouselActions, { children: [
          ...
          customLogo && /* @__PURE__ */ jsxRuntime.jsx(
            designSystem.IconButton,
            {
              disabled: !canUpdate,
              onClick: onResetLogo,
...
LogoInput.propTypes = {
  ...
  defaultLogo: PropTypes__default.default.string.isRequired,
  onChangeLogo: PropTypes__default.default.func.isRequired,
  onResetLogo: PropTypes__default.default.func.isRequired
};
const init = (initialState2, projectSettingsStored) => {
  const copyInitialState = merge__default.default(initialState2, {
    menuLogo: {
...
const CustomizationInfos = React.forwardRef(({ canUpdate, projectSettingsStored }, ref) => {
  const { formatMessage } = reactIntl.useIntl();
  const { trackUsage } = helperPlugin.useTracking();
  const {
    logos: { menu, auth }
  } = index.useConfiguration();
  const [{ menuLogo, authLogo }, dispatch] = React.useReducer(
    reducer,
    initialState,
...
CustomizationInfos.propTypes = {
  canUpdate: PropTypes__default.default.bool,
  projectSettingsStored: PropTypes__default.default.shape({
    menuLogo: PropTypes__default.default.shape({
      url: PropTypes__default.default.string,
      name: PropTypes__default.default.string
    })
  })
...
const ApplicationInfosPage = () => {
  ...
  const { updateProjectSettings } = index.useConfiguration();
  const permissions = reactRedux.useSelector(AuthenticatedApp.selectAdminPermissions);
  ...
  const AdminSeatInfo = index.useEnterprise(
    AdminSeatInfoCE,
    async () => (await Promise.resolve().then(() => require("./index-99e697a0.js"))).AdminSeatInfoEE
  );
  const {
    allowedActions: { canRead, canUpdate }
  } = helperPlugin.useRBAC(permissions.settings["project-settings"]);
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Layout, { children: [
    /* @__PURE__ */ jsxRuntime.jsx(helperPlugin.SettingsPageTitle, { name: "Application" }),
    /* @__PURE__ */ jsxRuntime.jsx(designSystem.Main, { children: isLoading ? /* @__PURE__ */ jsxRuntime.jsx(designSystem.Loader, { children: formatMessage({
      ...
      /* @__PURE__ */ jsxRuntime.jsx(
        designSystem.HeaderLayout,
        {
          ...
          primaryAction: canUpdate && /* @__PURE__ */ jsxRuntime.jsx(designSystem.Button, { type: "submit", startIcon: /* @__PURE__ */ jsxRuntime.jsx(Icons.Check, {}), children: formatMessage({ id: "global.save", defaultMessage: "Save" }) })
        }
      ),
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.ContentLayout, { children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { direction: "column", alignItems: "stretch", gap: 6, children: [
        ...
        canRead && data && /* @__PURE__ */ jsxRuntime.jsx(
          CustomizationInfos,
          {
            canUpdate,
            ref: inputsRef,
...
function makeUniqueRoutes(routes) {
  return routes.filter(
    (route, index2, refArray) => refArray.findIndex((obj) => obj.key === route.key) === index2
  );
}
function SettingsPage() {
  ...
  const routes = index.useEnterprise(
    ROUTES_CE,
    async () => (await Promise.resolve().then(() => require("./constants-bdccd418.js"))).ROUTES_EE,
    {
  ...
  const adminRoutes = React__namespace.useMemo(() => {
    return makeUniqueRoutes(
      routes.map(({ to, Component, exact }) => index.createRoute(Component, to, exact))
    );
  }, [routes]);
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Layout, { sideNav: /* @__PURE__ */ jsxRuntime.jsx(SettingsNav, { menu }), children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsxs(reactRouterDom.Switch, { children: [
      /* @__PURE__ */ jsxRuntime.jsx(reactRouterDom.Route, { path: "/settings/application-infos", component: ApplicationInfosPage, exact: true }),
      adminRoutes,
      pluginsRoutes
    ] })
  ] });
...
//# sourceMappingURL=index-8e785228.js.map
