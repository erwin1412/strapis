...
import { T as getBasename } from "./index-4c3eb885.mjs";
...
const SelectRoles = ({ disabled, error, onChange, value }) => {
  ...
  const startIcon = status === "loading" ? /* @__PURE__ */ jsx(Loader, {}) : void 0;
  return /* @__PURE__ */ jsx(
    Select,
    {
      id: "roles",
      ...
      children: (data || []).map((role) => {
        return /* @__PURE__ */ jsx(Option, { value: role.id.toString(), children: formatMessage({
          id: `global.${role.code}`,
...
//# sourceMappingURL=index-d0efe393.mjs.map
