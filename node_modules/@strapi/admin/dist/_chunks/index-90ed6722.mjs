...
import { m as makeSelectModelAndComponentSchemas, g as getTrad, s as selectFieldSizes, c as composeRefs, u as useDragAndDrop, a as createYupSchema, i as isFieldTypeNumber, b as makeSelectModelLinks, d as selectAppDomain } from "./schema-3e2e2e31.mjs";
...
const EditView = ({ allowedActions, isSingleType, goBack, slug, id, origin, userPermissions }) => {
  ...
  const Information2 = useEnterprise(
    InformationBoxCE,
    async () => (await import("./index-7315d2b7.mjs")).InformationBoxEE
  );
  useOnce(() => {
...
function ListView({ canCreate, canDelete, canRead, canPublish, layout, slug }) {
  ...
  const reviewWorkflowColumns = useEnterprise(
    ...
    async () => (await import("./constants-06e9c997.mjs")).REVIEW_WORKFLOW_COLUMNS_EE,
    {
  ...
  const ReviewWorkflowsColumns = useEnterprise(
    ...
    async () => {
      const { ReviewWorkflowsStageEE, ReviewWorkflowsAssigneeEE } = await import("./index-3a75aa07.mjs");
  ...
  const reviewWorkflowFilter = useEnterprise(
    ...
    async () => (await import("./constants-ea0a3cda.mjs")).REVIEW_WORKFLOW_FILTERS,
    {
...
//# sourceMappingURL=index-90ed6722.mjs.map
