...
FormTransferTokenContainer.propTypes = {
  ...
  transferToken: PropTypes__default.default.shape({
...
LoadingView.propTypes = {
  transferTokenName: PropTypes__default.default.string
};
const schema = yup__namespace.object().shape({
  ...
  permissions: yup__namespace.string(helperPlugin.translatedErrors.string).required(helperPlugin.translatedErrors.required)
});
...
const TransferTokenCreateView = () => {
  ...
  const {
    params: { id }
  } = reactRouterDom.useRouteMatch("/settings/transfer-tokens/:id");
  ...
  if (isLoading) {
    return /* @__PURE__ */ jsxRuntime.jsx(LoadingView, { transferTokenName: transferToken?.name });
  }
        ...
        children: ({ errors, handleChange, isSubmitting, values }) => {
          return /* @__PURE__ */ jsxRuntime.jsxs(helperPlugin.Form, { children: [
            ...
            /* @__PURE__ */ jsxRuntime.jsx(designSystem.ContentLayout, { children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { direction: "column", alignItems: "stretch", gap: 6, children: [
              Boolean(transferToken?.name) && /* @__PURE__ */ jsxRuntime.jsx(index.TokenBox, { token: transferToken?.accessKey, tokenType: constants.TRANSFER_TOKEN_TYPE }),
              /* @__PURE__ */ jsxRuntime.jsx(
...
exports.TransferTokenCreateView = TransferTokenCreateView;
//# sourceMappingURL=index-cfe5eadd.js.map
