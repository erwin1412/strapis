...
import { useAPIErrorHandler, useNotification, useFocusWhenNavigate, useRBAC, useFetchClient, SettingsPageTitle, LinkButton, LoadingIndicatorPage, onRowClick, stopPropagation, ConfirmDialog, CheckPagePermissions } from "@strapi/helper-plugin";
    ...
    /* @__PURE__ */ jsxs(Main, { "aria-busy": isLoading, children: [
      /* @__PURE__ */ jsx(
        HeaderLayout,
        {
          ...
          primaryAction: canCreate && !isLoading && /* @__PURE__ */ jsx(LinkButton, { startIcon: /* @__PURE__ */ jsx(Plus, {}), variant: "default", to: `${pathname}/create`, size: "S", children: formatMessage({
      ...
      /* @__PURE__ */ jsx(ContentLayout, { children: isLoading ? /* @__PURE__ */ jsx(Box, { background: "neutral0", padding: 6, shadow: "filterShadow", hasRadius: true, children: /* @__PURE__ */ jsx(LoadingIndicatorPage, {}) }) : numberOfWebhooks > 0 ? /* @__PURE__ */ jsxs(
        Table,
        {
          ...
          footer: /* @__PURE__ */ jsx(TFooter, { onClick: () => canCreate ? goTo("create") : {}, icon: /* @__PURE__ */ jsx(Plus, {}), children: formatMessage({
            id: "Settings.webhooks.list.button.add",
            defaultMessage: "Create new webhook"
          }) }),
          children: [
...
const ProtectedListView = () => {
  const permissions = useSelector(selectAdminPermissions);
  return /* @__PURE__ */ jsx(CheckPagePermissions, { permissions: permissions.settings.webhooks.main, children: /* @__PURE__ */ jsx(ListView, {}) });
};
export {
  ProtectedListView as default
};
//# sourceMappingURL=index-a985e784.mjs.map
