...
import { onRowClick, stopPropagation, translatedErrors, useNotification, useOverlayBlocker, useFetchClient, Form, GenericInput, PageSizeURLQuery, PaginationURLQuery, Status, useAPIErrorHandler, useRBAC, useFocusWhenNavigate, SettingsPageTitle, SearchURLQuery, NoPermissions, DynamicTable, CheckPagePermissions } from "@strapi/helper-plugin";
import { useSelector } from "react-redux";
import { g as getFullName, s as selectAdminPermissions } from "./AuthenticatedApp-5524c90a.mjs";
import { useState } from "react";
import { Button, Tbody, Tr, Td, BaseCheckbox, Typography, Flex, IconButton, Box, ModalLayout, ModalHeader, ModalBody, Grid, GridItem, ModalFooter, Main, HeaderLayout, ActionLayout, ContentLayout } from "@strapi/design-system";
import qs__default from "qs";
import { useIntl } from "react-intl";
import { useMutation, useQueryClient } from "react-query";
import { useHistory, useLocation } from "react-router-dom";
import { u as useAdminUsers } from "./useAdminUsers-09f86a58.mjs";
import { p as useEnterprise } from "./index-4c3eb885.mjs";
import { F as Filters } from "./index-74812118.mjs";
import { Envelop, Pencil, Trash } from "@strapi/icons";
import PropTypes from "prop-types";
import { Breadcrumbs, Crumb } from "@strapi/design-system/v2";
import { Formik } from "formik";
import { M as MagicLinkCE, S as SelectRoles } from "./index-d0efe393.mjs";
      ...
      Tr,
      {
        ...
        children: [
          ...
          headers.map(({ key, cellFormatter, name, ...rest }) => {
            return /* @__PURE__ */ jsx(Td, { children: typeof cellFormatter === "function" ? cellFormatter(data, { key, name, formatMessage, ...rest }) : /* @__PURE__ */ jsx(Typography, { textColor: "neutral800", children: data[name] || "-" }) }, key);
          }),
...
const ModalForm = ({ onSuccess, onToggle }) => {
  ...
  const roleLayout = useEnterprise(
    ROLE_LAYOUT,
    async () => (await import("./constants-def33545.mjs")).ROLE_LAYOUT,
    {
  ...
  const initialValues = useEnterprise(
    FORM_INITIAL_VALUES,
    async () => (await import("./constants-def33545.mjs")).FORM_INITIAL_VALUES,
    {
  ...
  const MagicLink = useEnterprise(
    MagicLinkCE,
    async () => (await import("./index-f2acdf04.mjs")).MagicLinkEE
  );
  ...
  },
  {
    ...
    cellFormatter({ isActive }, { formatMessage }) {
      return /* @__PURE__ */ jsxs(Flex, { children: [
        /* @__PURE__ */ jsx(Status, { isActive, variant: isActive ? "success" : "danger" }),
...
const UserListPageCE = () => {
  ...
  } = useAdminUsers(qs__default.parse(search, { ignoreQueryPrefix: true }), {
    cacheTime: 0,
    enabled: canRead
  });
  const CreateAction = useEnterprise(
    CreateActionCE,
    async () => (await import("./index-973c363e.mjs")).CreateActionEE
  );
    ...
    canRead && /* @__PURE__ */ jsx(
      ActionLayout,
      {
        startActions: /* @__PURE__ */ jsxs(Fragment, { children: [
          ...
          /* @__PURE__ */ jsx(Filters, { displayedFilters })
        ] })
      }
    ),
    /* @__PURE__ */ jsxs(ContentLayout, { canRead, children: [
      ...
      canRead && /* @__PURE__ */ jsxs(Fragment, { children: [
        ...
        pagination && /* @__PURE__ */ jsx(PaginationFooter, { pagination })
      ] })
    ] }),
...
const UsersListPageSwitch = () => {
  const UsersListPage = useEnterprise(
    ...
    async () => (
      ...
      (await import("./index-a47f4f4e.mjs")).UserListPageEE
    )
  );
  if (!UsersListPage) {
    return null;
...
const ProtectedListPage = () => {
  const permissions = useSelector(selectAdminPermissions);
  return /* @__PURE__ */ jsx(CheckPagePermissions, { permissions: permissions.settings.users.main, children: /* @__PURE__ */ jsx(UsersListPageSwitch, {}) });
};
...
//# sourceMappingURL=index-3407e4e6.mjs.map
