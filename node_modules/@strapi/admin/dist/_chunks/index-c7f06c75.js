...
const AuthenticatedApp = require("./AuthenticatedApp-96716173.js");
const schema = require("./schema-672225f4.js");
...
const index$2 = require("./index-83e78ac3.js");
...
const flatMap__default = /* @__PURE__ */ _interopDefault(flatMap);
...
const reducer$3 = (state, action) => produce__default.default(state, (draftState) => {
  switch (action.type) {
    case "GET_DATA": {
...
const createDefaultForm = (attributes, allComponentsSchema) => {
  return Object.keys(attributes).reduce((acc, current) => {
    const attribute = get__default.default(attributes, [current], {});
...
const formatLayoutToApi = ({ layouts, metadatas, ...rest }) => {
  ...
  const formattedMetadatas = Object.keys(metadatas).reduce((acc, current) => {
    const currentMetadatas = get__default.default(metadatas, [current], {});
...
const mergeMetasWithSchema = (data, schemas, mainSchemaKey) => {
  ...
  set__default.default(merged, [mainSchemaKey], merge__default.default({}, mainSchema, data[mainSchemaKey]));
  Object.keys(data.components).forEach((compoUID) => {
    const compoSchema = findSchema(compoUID);
    set__default.default(merged, ["components", compoUID], { ...data.components[compoUID], ...compoSchema });
  });
  return merged;
};
const removePasswordFieldsFromData = (data, contentTypeSchema, componentSchema) => {
  const recursiveCleanData = (data2, schema2) => {
    return Object.keys(data2).reduce((acc, current) => {
      const attrType = helperPlugin.getType(schema2, current);
      const value = get__default.default(data2, current);
      const component = helperPlugin.getOtherInfos(schema2, [current, "component"]);
      const isRepeatable = helperPlugin.getOtherInfos(schema2, [current, "repeatable"]);
...
const formatLayouts = (initialData, models) => {
  ...
  set__default.default(data, ["contentType", "layouts", "edit"], formattedCTEditLayout);
  set__default.default(data, ["contentType", "layouts", "list"], formattedListLayout);
  Object.keys(data.components).forEach((componentUid) => {
    ...
    set__default.default(data, ["components", componentUid, "layouts", "edit"], formattedComponentEditLayout);
  });
  return data;
};
const createMetasSchema = (initialData, models) => {
  ...
  const formatMetadatas = (targetSchema) => {
    return Object.keys(targetSchema.metadatas).reduce((acc, current) => {
      const schema2 = get__default.default(targetSchema, ["attributes", current], {});
      let metadatas = targetSchema.metadatas[current];
      if (schema2.type === "relation") {
        const relationModel = getRelationModel(schema2.targetModel, models);
        const mainFieldName = metadatas.edit.mainField;
        const mainField = {
          name: mainFieldName,
          schema: get__default.default(relationModel, ["attributes", mainFieldName])
        };
        metadatas = {
          list: {
            ...metadatas.list,
  ...
  set__default.default(data, ["contentType", "metadatas"], formatMetadatas(contentType));
  Object.keys(components).forEach((compoUID) => {
    ...
    set__default.default(data, ["components", compoUID, "metadatas"], updatedMetas);
  });
  return data;
};
const formatLayoutWithMetas = (contentTypeConfiguration, models) => contentTypeConfiguration.layouts.edit.reduce((acc, current) => {
  const row = current.map((attribute) => {
    const fieldSchema = get__default.default(contentTypeConfiguration, ["attributes", attribute.name], {});
    const data = {
      ...attribute,
      fieldSchema,
      metadatas: get__default.default(contentTypeConfiguration, ["metadatas", attribute.name, "edit"], {})
    };
    if (fieldSchema.type === "relation") {
      ...
      set__default.default(data, "targetModelPluginOptions", targetModelPluginOptions);
      set__default.default(data, "queryInfos", {
...
const formatListLayoutWithMetas = (contentTypeConfiguration, components) => {
  const formatted = contentTypeConfiguration.layouts.list.reduce((acc, current) => {
    const fieldSchema = get__default.default(contentTypeConfiguration, ["attributes", current], {});
    const metadatas = get__default.default(contentTypeConfiguration, ["metadatas", current, "list"], {});
...
const shouldDisplayRelationLink = (contentTypeConfiguration, fieldName, models) => {
  const targetModel = get__default.default(contentTypeConfiguration, ["attributes", fieldName, "targetModel"], "");
...
const useFetchContentTypeLayout = (contentTypeUID) => {
  const [{ error, isLoading, layout, layouts }, dispatch] = React.useReducer(reducer$3, initialState$3);
  const schemasSelector = React.useMemo(schema.makeSelectModelAndComponentSchemas, []);
  const { schemas } = reactRedux.useSelector((state) => schemasSelector(state), reactRedux.shallowEqual);
  ...
  const getData2 = React.useCallback(
    async (uid, source) => {
      ...
      try {
        ...
        if (axios__default.default.isCancel(error2)) {
          return;
        }
...
const mergeParams = (initialParams, params) => {
  return Object.keys(initialParams).reduce((acc, current) => {
    ...
    const nextValue = get__default.default(params, [current], intialValue);
    if (isObject__default.default(intialValue)) {
...
const useFindRedirectionLink = (slug) => {
  ...
  const collectionTypesMenuLinks = reactRedux.useSelector(selectMenuLinks);
...
const resetPermissions = () => ({ type: index$2.RESET_PERMISSIONS });
...
const useSyncRbac = (query, collectionTypeUID, containerName = "listView") => {
  ...
  const collectionTypesRelatedPermissions = reactRedux.useSelector(selectCollectionTypePermissions);
  const permissions2 = reactRedux.useSelector(selectPermissions);
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(helperPlugin.CheckPermissions, { permissions, children: /* @__PURE__ */ jsxRuntime.jsx(
    helperPlugin.LinkButton,
    {
      ...
      children: formatMessage({
        id: schema.getTrad(`edit-settings-view.link-to-ctb.${type}`),
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Box, { padding: 3, children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { paddingTop: 2, children: /* @__PURE__ */ jsxRuntime.jsx(
      helperPlugin.Link,
      {
        ...
        children: formatMessage({
          id: schema.getTrad("components.FieldItem.linkToComponentLayout"),
...
ComponentIcon.propTypes = {
  showBackground: PropTypes__default.default.bool,
      ...
      /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { children: [
        /* @__PURE__ */ jsxRuntime.jsx(
          CustomIconButton$2,
          {
            label: formatMessage(
              {
                id: schema.getTrad("containers.ListSettingsView.modal-form.edit-label"),
...
`;
const DragButton$2 = styled__default.default(designSystem.Flex)`
  cursor: all-scroll;
...
const RowsLayout = ({ row, onRemoveField, rowIndex }) => {
  return /* @__PURE__ */ jsxRuntime.jsx(designSystem.Grid, { children: row.rowContent.map((rowItem, index2) => {
    return /* @__PURE__ */ jsxRuntime.jsx(
      RowItemsLayout,
      {
        rowItem,
...
const DisplayedFields = ({ editLayout, fields, onRemoveField, onAddField }) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { direction: "column", alignItems: "stretch", gap: 4, children: [
    /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { justifyContent: "space-between", children: [
      /* @__PURE__ */ jsxRuntime.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { fontWeight: "bold", children: formatMessage({
          id: schema.getTrad("containers.ListPage.displayedFields"),
    ...
    /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { padding: 4, hasRadius: true, borderStyle: "dashed", borderWidth: "1px", borderColor: "neutral300", children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { direction: "column", alignItems: "stretch", gap: 2, children: [
      editLayout.map((row, index2) => /* @__PURE__ */ jsxRuntime.jsx(RowsLayout, { row, rowIndex: index2, onRemoveField }, row.rowId)),
      /* @__PURE__ */ jsxRuntime.jsxs(v2.Menu.Root, { children: [
        /* @__PURE__ */ jsxRuntime.jsx(
          v2.Menu.Trigger,
          {
            ...
            variant: "secondary",
            children: formatMessage({
              id: schema.getTrad("containers.SettingPage.add.field"),
...
const getInputProps = (fieldName) => {
  ...
  const labelId = fieldName === "mainField" ? schema.getTrad("containers.SettingPage.editSettings.entry.title") : schema.getTrad(`form.Input.${fieldName}`);
...
const ModalForm = ({ onMetaChange, onSizeChange }) => {
  ...
  const schemasSelector = React.useMemo(schema.makeSelectModelAndComponentSchemas, []);
  const { schemas } = reactRedux.useSelector((state) => schemasSelector(state), reactRedux.shallowEqual);
  const fieldSizes = reactRedux.useSelector(schema.selectFieldSizes);
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(designSystem.GridItem, { col: 6, children: /* @__PURE__ */ jsxRuntime.jsx(
      GenericInput,
      {
        ...
        hint: meta === "mainField" ? formatMessage({
          id: schema.getTrad("containers.SettingPage.editSettings.relation-field.description")
        }) : "",
        label: formatMessage({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
    ...
    isResizable && /* @__PURE__ */ jsxRuntime.jsx(designSystem.GridItem, { col: 6, children: /* @__PURE__ */ jsxRuntime.jsx(
      designSystem.Select,
      {
        ...
        label: formatMessage({
          id: schema.getTrad("containers.SettingPage.editSettings.size.label"),
          defaultMessage: "Size"
        }),
        ...
        /* @__PURE__ */ jsxRuntime.jsxs("form", { onSubmit: handleSubmit, children: [
          /* @__PURE__ */ jsxRuntime.jsx(
            designSystem.HeaderLayout,
            {
              title: formatMessage(
                {
                  id: schema.getTrad("components.SettingsViewWrapper.pluginHeader.title"),
                  defaultMessage: `Configure the view - ${upperFirst__default.default(modelName)}`
                },
                { name: upperFirst__default.default(modelName) }
              ),
              subtitle: formatMessage({
                id: schema.getTrad("components.SettingsViewWrapper.pluginHeader.description.edit-settings"),
            ...
            designSystem.Box,
            {
              ...
              children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { direction: "column", alignItems: "stretch", gap: 4, children: [
                /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { variant: "delta", as: "h2", children: formatMessage({
                  id: schema.getTrad("containers.SettingPage.settings"),
                ...
                /* @__PURE__ */ jsxRuntime.jsx(designSystem.Grid, { children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.GridItem, { col: 6, s: 12, children: /* @__PURE__ */ jsxRuntime.jsx(
                  ...
                  {
                    label: formatMessage({
                      id: schema.getTrad("containers.SettingPage.editSettings.entry.title"),
                      defaultMessage: "Entry title"
                    }),
                    hint: formatMessage({
                      id: schema.getTrad("containers.SettingPage.editSettings.entry.title.description"),
                ...
                /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { variant: "delta", as: "h3", children: formatMessage({
                  id: schema.getTrad("containers.SettingPage.view"),
                  defaultMessage: "View"
                }) }),
                /* @__PURE__ */ jsxRuntime.jsx(
                  DisplayedFields,
          ...
          /* @__PURE__ */ jsxRuntime.jsx(
            ...
            {
              bodyText: {
                id: schema.getTrad("popUpWarning.warning.updateAllSettings"),
...
const resetProps$2 = () => ({ type: index$2.RESET_PROPS });
const setLayout$1 = (layout, query) => ({
  type: index$2.SET_LAYOUT,
  layout,
  query
});
const getData$1 = () => {
  return {
    type: index$2.GET_DATA
  };
};
const getDataSucceeded$1 = (data) => ({
  type: index$2.GET_DATA_SUCCEEDED,
  data
});
const initForm = (rawQuery, isSingleType = false) => ({
  type: index$2.INIT_FORM,
  rawQuery,
  isSingleType
});
const resetProps$1 = () => ({ type: index$2.RESET_PROPS$1 });
const setDataStructures = (componentsDataStructure, contentTypeDataStructure) => ({
  type: index$2.SET_DATA_STRUCTURES,
  componentsDataStructure,
  contentTypeDataStructure
});
const setStatus = (status) => ({
  type: index$2.SET_STATUS,
  status
});
const submitSucceeded = (data) => ({
  type: index$2.SUBMIT_SUCCEEDED,
  data
});
const clearSetModifiedDataOnly = () => ({
  type: index$2.CLEAR_SET_MODIFIED_DATA_ONLY
});
...
const CollectionTypeFormWrapper = ({ allLayoutData, children, slug, id, origin }) => {
  ...
  const dispatch = reactRedux.useDispatch();
  const { componentsDataStructure, contentTypeDataStructure, data, isLoading, status } = reactRedux.useSelector(selectCrudReducer);
  const redirectionLink = useFindRedirectionLink(slug);
  const { formatAPIError } = helperPlugin.useAPIErrorHandler(schema.getTrad);
  const isMounted = React.useRef(true);
  const trackUsageRef = React.useRef(trackUsage);
  const allLayoutDataRef = React.useRef(allLayoutData);
  ...
  const cleanReceivedData = React.useCallback((data2) => {
  ...
  React.useEffect(() => {
    const componentsDataStructure2 = Object.keys(allLayoutData.components).reduce((acc, current) => {
      const defaultComponentForm = createDefaultForm(
        get__default.default(allLayoutData, ["components", current, "attributes"], {}),
    ...
    const fetchData = async (source2) => {
      ...
      try {
        ...
        if (resStatus === 403) {
          toggleNotification({
            type: "info",
            message: { id: schema.getTrad("permissions.not-allowed.update") }
          });
          push(redirectionLink);
        }
      }
  ...
  const onDelete = React.useCallback(
    async (trackerProperty) => {
      try {
        ...
        toggleNotification({
          type: "success",
          message: { id: schema.getTrad("success.record.delete") }
        });
  ...
  const onPost = React.useCallback(
    async (body, trackerProperty) => {
      ...
      try {
        ...
        toggleNotification({
          type: "success",
          message: { id: schema.getTrad("success.record.save") }
        });
  ...
  const onPublish = React.useCallback(async () => {
    try {
      ...
      toggleNotification({
        type: "success",
        message: { id: schema.getTrad("success.record.publish") }
      });
      return Promise.resolve(data2);
    } catch (err) {
      displayErrors(err);
  ...
  const onUnpublish = React.useCallback(async () => {
    ...
    try {
      ...
      toggleNotification({
        type: "success",
        message: { id: schema.getTrad("success.record.unpublish") }
      });
      dispatch(submitSucceeded(cleanReceivedData(data2)));
      dispatch(setStatus("resolved"));
      return Promise.resolve(data2);
...
CollectionTypeFormWrapper.propTypes = {
  allLayoutData: PropTypes__default.default.exact({
    components: PropTypes__default.default.object.isRequired,
    contentType: PropTypes__default.default.shape({
      apiID: PropTypes__default.default.string.isRequired,
      attributes: PropTypes__default.default.object.isRequired,
      info: PropTypes__default.default.object.isRequired,
      isDisplayed: PropTypes__default.default.bool.isRequired,
      kind: PropTypes__default.default.string.isRequired,
      layouts: PropTypes__default.default.object.isRequired,
      metadatas: PropTypes__default.default.object.isRequired,
      options: PropTypes__default.default.object.isRequired,
...
const CollectionTypeFormWrapper$1 = React.memo(CollectionTypeFormWrapper, isEqual__default.default);
...
ComponentCategory.propTypes = {
  ...
  components: PropTypes__default.default.array,
  isOpen: PropTypes__default.default.bool,
  onAddComponent: PropTypes__default.default.func.isRequired,
  onToggle: PropTypes__default.default.func.isRequired,
    ...
    designSystem.Box,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntime.jsx(designSystem.Flex, { justifyContent: "center", children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { fontWeight: "bold", textColor: "neutral600", children: formatMessage({
          id: schema.getTrad("components.DynamicZone.ComponentPicker-label"),
...
ComponentPicker.propTypes = {
  dynamicComponentsByCategory: PropTypes__default.default.shape({
  ...
  isOpen: PropTypes__default.default.bool,
  onClickAddComponent: PropTypes__default.default.func.isRequired
};
    ...
    /* @__PURE__ */ jsxRuntime.jsx(
      designSystem.Box,
      {
        ...
        children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { direction: "column", gap: 2, children: [
          /* @__PURE__ */ jsxRuntime.jsx(designSystem.Flex, { justifyContent: "center", style: { cursor: isReadOnly ? "not-allowed" : "inherit" }, children: /* @__PURE__ */ jsxRuntime.jsx(IconWrapper, { children: /* @__PURE__ */ jsxRuntime.jsx(Icons.PlusCircle, {}) }) }),
          /* @__PURE__ */ jsxRuntime.jsx(designSystem.Flex, { justifyContent: "center", children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { textColor: "primary600", variant: "pi", fontWeight: "bold", children: formatMessage({
            id: schema.getTrad("components.empty-repeatable"),
...
function useBlocksStore() {
  return {
    ...
    quote: {
      renderElement: (props) => /* @__PURE__ */ jsxRuntime.jsx(Blockquote, { ...props.attributes, children: props.children }),
      icon: Icons.Quote,
      label: {
      ...
      handleEnterKey(editor) {
        ...
        if (isNodeEnd && isEmptyLine) {
          ...
          if (isNodeEnd) {
            ...
            slate.Editor.removeMark(editor, "italic");
          }
        }
      }
    },
...
const isLastBlockType = (editor, type) => {
  ...
  if (currentBlock) {
    ...
    const isNodeAfter = Boolean(slate.Editor.after(editor, currentNodePath));
    return !isNodeAfter;
  }
  return false;
};
...
const InputUID = React__namespace.forwardRef(
  ({
    ...
    const [availability, setAvailability] = React__namespace.useState(null);
    const [showRegenerate, setShowRegenerate] = React__namespace.useState(false);
    const debouncedValue = useDebounce.useDebounce(value, 300);
...
InputUID.propTypes = {
  contentTypeUID: PropTypes__default.default.string.isRequired,
  disabled: PropTypes__default.default.bool,
  error: PropTypes__default.default.string,
  intlLabel: PropTypes__default.default.shape({
    id: PropTypes__default.default.string.isRequired,
...
function connect$5(WrappedComponent, select) {
  return (props) => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(WrappedComponent, { ...props, ...selectors });
  };
}
...
function useSelect$5({
  ...
  const { params } = reactRouterDom.useRouteMatch("/content-manager/collectionType/:collectionType/create/clone/:origin") ?? {};
  const { origin } = params ?? {};
  ...
  let componentId;
  if (componentUid) {
    componentId = get__default.default(modifiedData, fieldNameKeys.slice(0, -1))?.id;
  }
...
const Option = ({ publicationState, mainField, id }) => {
  ...
  if (publicationState) {
    ...
    const draftMessage = {
      id: schema.getTrad("components.Select.draft-info-title"),
      defaultMessage: "State: Draft"
    };
    const publishedMessage = {
      id: schema.getTrad("components.Select.publish-info-title"),
      defaultMessage: "State: Published"
    };
    const title = isDraft ? formatMessage(draftMessage) : formatMessage(publishedMessage);
    return /* @__PURE__ */ jsxRuntime.jsx(designSystem.ComboboxOption, { value: id, textValue: stringifiedDisplayValue, children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { children: [
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(designSystem.ComboboxOption, { value: id, textValue: stringifiedDisplayValue, children: stringifiedDisplayValue });
};
Option.defaultProps = {
  mainField: void 0,
...
Option.propTypes = {
  ...
  mainField: PropTypes__default.default.oneOfType([PropTypes__default.default.string, PropTypes__default.default.number]),
  publicationState: PropTypes__default.default.oneOfType([PropTypes__default.default.string, PropTypes__default.default.bool])
};
...
const RelationItem = ({
  ...
  const [{ handlerId, isDragging, handleKeyDown }, relationRef, dropRef, dragRef, dragPreviewRef] = schema.useDragAndDrop(canDrag && !disabled, {
  ...
  const composedRefs = schema.composeRefs(relationRef, dragRef);
  React.useEffect(() => {
...
RelationItem.propTypes = {
  ...
  children: PropTypes__default.default.node.isRequired,
  displayValue: PropTypes__default.default.string,
  disabled: PropTypes__default.default.bool,
  endAction: PropTypes__default.default.node,
  iconButtonAriaLabel: PropTypes__default.default.string.isRequired,
  id: PropTypes__default.default.number.isRequired,
  index: PropTypes__default.default.number.isRequired,
  name: PropTypes__default.default.string.isRequired,
  onCancel: PropTypes__default.default.func,
  onDropItem: PropTypes__default.default.func,
  onGrabItem: PropTypes__default.default.func,
  ...
  updatePositionOfRelation: PropTypes__default.default.func
};
...
const RelationList = ({ children, overflow, ...props }) => {
  return /* @__PURE__ */ jsxRuntime.jsx(ShadowBox, { overflowDirection: overflow, ...props, children });
};
...
RelationList.propTypes = {
  children: PropTypes__default.default.node.isRequired,
  overflow: PropTypes__default.default.oneOf(["top-bottom", "bottom", "top", ""])
};
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    designSystem.Flex,
    {
      ...
      children: [
        ...
        relations.length > 0 && /* @__PURE__ */ jsxRuntime.jsxs(RelationList, { overflow, children: [
...
const RelationsResult = PropTypes__default.default.shape({
  ...
  isFetchingNextPage: PropTypes__default.default.bool.isRequired,
  isLoading: PropTypes__default.default.bool.isRequired,
  isSuccess: PropTypes__default.default.bool.isRequired
});
const SearchResults = PropTypes__default.default.shape({
  data: PropTypes__default.default.arrayOf(
    PropTypes__default.default.shape({
      id: PropTypes__default.default.number.isRequired,
      href: PropTypes__default.default.string,
...
RelationInput.propTypes = {
  error: PropTypes__default.default.string,
  canReorder: PropTypes__default.default.bool,
  ...
  labelAction: PropTypes__default.default.element,
  labelLoadMore: PropTypes__default.default.string,
  labelDisconnectRelation: PropTypes__default.default.string.isRequired,
  listAriaDescription: PropTypes__default.default.string.isRequired,
  liveText: PropTypes__default.default.string,
  loadingMessage: PropTypes__default.default.string.isRequired,
  name: PropTypes__default.default.string.isRequired,
  noRelationsMessage: PropTypes__default.default.string.isRequired,
  numberOfRelationsToDisplay: PropTypes__default.default.number.isRequired,
  onCancel: PropTypes__default.default.func,
  onDropItem: PropTypes__default.default.func,
  onGrabItem: PropTypes__default.default.func,
  onRelationConnect: PropTypes__default.default.func.isRequired,
  onRelationDisconnect: PropTypes__default.default.func.isRequired,
  onRelationLoadMore: PropTypes__default.default.func.isRequired,
  onRelationReorder: PropTypes__default.default.func.isRequired,
  onSearch: PropTypes__default.default.func.isRequired,
  onSearchNextPage: PropTypes__default.default.func.isRequired,
  placeholder: PropTypes__default.default.string.isRequired,
  publicationStateTranslations: PropTypes__default.default.shape({
    draft: PropTypes__default.default.string.isRequired,
    published: PropTypes__default.default.string.isRequired
  }).isRequired,
  required: PropTypes__default.default.bool,
...
ListItem.propTypes = {
  data: PropTypes__default.default.shape({
    ariaDescribedBy: PropTypes__default.default.string.isRequired,
    canDrag: PropTypes__default.default.bool.isRequired,
    disabled: PropTypes__default.default.bool.isRequired,
    handleCancel: PropTypes__default.default.func,
    handleDropItem: PropTypes__default.default.func,
    handleGrabItem: PropTypes__default.default.func,
    iconButtonAriaLabel: PropTypes__default.default.string.isRequired,
    labelDisconnectRelation: PropTypes__default.default.string.isRequired,
    name: PropTypes__default.default.string.isRequired,
    onRelationDisconnect: PropTypes__default.default.func.isRequired,
    ...
    relations: PropTypes__default.default.arrayOf(
      PropTypes__default.default.shape({
        href: PropTypes__default.default.string,
        id: PropTypes__default.default.number.isRequired,
        publicationState: PropTypes__default.default.oneOfType([PropTypes__default.default.string, PropTypes__default.default.bool]),
    ...
    updatePositionOfRelation: PropTypes__default.default.func.isRequired
  }),
  index: PropTypes__default.default.number.isRequired,
...
const RelationInputDataManager = ({
  ...
  const isMorph = React.useMemo(() => relationType.toLowerCase().includes("morph"), [relationType]);
  const toOneRelation = [
    "oneWay",
    "oneToOne",
    "manyToOne",
  ...
  const handleGrabItem = (index2) => {
    ...
    setLiveText(
      formatMessage(
        {
          id: schema.getTrad("dnd.grab-item"),
  ...
  const handleDropItem = (index2) => {
    ...
    setLiveText(
      formatMessage(
        {
          id: schema.getTrad("dnd.drop-item"),
  ...
  const handleCancel = (index2) => {
    ...
    setLiveText(
      formatMessage(
        {
          id: schema.getTrad("dnd.cancel-item"),
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    RelationInput,
    {
      ...
      iconButtonAriaLabel: formatMessage({
        id: schema.getTrad("components.RelationInput.icon-button-aria-label"),
        defaultMessage: "Drag"
      }),
      id: name,
      label: `${formatMessage({
      ...
      labelLoadMore: !isCreatingEntry || isCloningEntry ? formatMessage({
        id: schema.getTrad("relation.loadMore"),
        defaultMessage: "Load More"
      }) : null,
      labelDisconnectRelation: formatMessage({
        id: schema.getTrad("relation.disconnect"),
        defaultMessage: "Remove"
      }),
      listAriaDescription: formatMessage({
        id: schema.getTrad("dnd.instructions"),
        defaultMessage: `Press spacebar to grab and re-order`
      }),
      listHeight: 320,
      liveText,
      loadingMessage: formatMessage({
        id: schema.getTrad("relation.isLoading"),
        defaultMessage: "Relations are loading"
      }),
      name,
      noRelationsMessage: formatMessage({
        id: schema.getTrad("relation.notAvailable"),
      ...
      placeholder: formatMessage(
        placeholder || {
          id: schema.getTrad("relation.add"),
          defaultMessage: "Add relation"
        }
      ),
      publicationStateTranslations: {
        [PUBLICATION_STATES.DRAFT]: formatMessage({
          id: schema.getTrad("relation.publicationState.draft"),
          defaultMessage: "Draft"
        }),
        [PUBLICATION_STATES.PUBLISHED]: formatMessage({
          id: schema.getTrad("relation.publicationState.published"),
...
RelationInputDataManager.propTypes = {
  ...
  entityId: PropTypes__default.default.number,
  ...
  labelAction: PropTypes__default.default.element,
  isCloningEntry: PropTypes__default.default.bool.isRequired,
  isCreatingEntry: PropTypes__default.default.bool.isRequired,
  isComponentRelation: PropTypes__default.default.bool,
  isFieldAllowed: PropTypes__default.default.bool,
  isFieldReadable: PropTypes__default.default.bool.isRequired,
  ...
  required: PropTypes__default.default.bool,
  relationType: PropTypes__default.default.string.isRequired,
  size: PropTypes__default.default.number.isRequired,
  targetModel: PropTypes__default.default.string.isRequired,
  queryInfos: PropTypes__default.default.shape({
    defaultParams: PropTypes__default.default.shape({
      locale: PropTypes__default.default.string
    }),
    endpoints: PropTypes__default.default.shape({
      relation: PropTypes__default.default.string,
      search: PropTypes__default.default.string.isRequired
    }).isRequired,
    shouldDisplayRelationLink: PropTypes__default.default.bool.isRequired
  }).isRequired
};
const Memoized$4 = React.memo(RelationInputDataManager);
...
const clean = (dirty) => sanitizeHtml__default.default(dirty, options);
...
const PreviewWysiwyg = ({ data }) => {
  const html = React.useMemo(() => clean(md.render(data.replaceAll("\\n", "\n") || "")), [data]);
...
const PreviewWysiwyg$1 = React.memo(PreviewWysiwyg);
...
const Editor = React.forwardRef(
  ({
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(EditorAndPreviewWrapper, { children: [
      ...
      isPreviewMode && /* @__PURE__ */ jsxRuntime.jsx(PreviewWysiwyg$1, { data: value })
    ] });
  }
);
Editor.defaultProps = {
...
Editor.propTypes = {
  disabled: PropTypes__default.default.bool,
  editorRef: PropTypes__default.default.shape({ current: PropTypes__default.default.any }).isRequired,
  error: PropTypes__default.default.string,
  isPreviewMode: PropTypes__default.default.bool,
  isExpandMode: PropTypes__default.default.bool,
  name: PropTypes__default.default.string.isRequired,
  onChange: PropTypes__default.default.func.isRequired,
  placeholder: PropTypes__default.default.string,
  textareaRef: PropTypes__default.default.shape({ current: PropTypes__default.default.any }).isRequired,
  value: PropTypes__default.default.string
};
...
const EditorLayout = ({ children, isExpandMode, error, previewContent, onCollapse }) => {
  const { formatMessage } = reactIntl.useIntl();
  helperPlugin.useLockScroll(isExpandMode);
  if (isExpandMode) {
          ...
          designSystem.Box,
          {
            ...
            children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { height: "100%", alignItems: "flex-start", children: [
              ...
              /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { alignItems: "start", direction: "column", flex: 1, height: "100%", width: "100%", children: [
                ...
                /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { position: "relative", height: "100%", width: "100%", children: /* @__PURE__ */ jsxRuntime.jsx(PreviewWysiwyg$1, { data: previewContent }) })
              ] })
            ] })
          }
        )
...
EditorLayout.propTypes = {
  children: PropTypes__default.default.node.isRequired,
  error: PropTypes__default.default.string,
  isExpandMode: PropTypes__default.default.bool.isRequired,
  previewContent: PropTypes__default.default.string,
  onCollapse: PropTypes__default.default.func.isRequired
};
...
WysiwygFooter.propTypes = {
  onToggleExpand: PropTypes__default.default.func
};
const WysiwygNav = ({
  disabled,
  editorRef,
  ...
  const buttonMoreRef = React.useRef();
...
WysiwygNav.propTypes = {
  ...
  onToggleMediaLib: PropTypes__default.default.func,
  onTogglePreviewMode: PropTypes__default.default.func
};
...
const Wysiwyg = React.forwardRef(
  ({ hint, disabled, error, intlLabel, labelAction, name, onChange, placeholder, value, required }, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
      ...
      error && /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { paddingTop: 1, children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { variant: "pi", textColor: "danger600", "data-strapi-field-error": true, children: error }) }),
      mediaLibVisible && /* @__PURE__ */ jsxRuntime.jsx(MediaLibraryDialog, { onClose: handleToggleMediaLib, onSelectAssets: handleSelectAssets })
    ] });
  }
);
...
const getInputType = (type = "") => {
  switch (toLower__default.default(type)) {
    case "blocks":
      return "blocks";
    case "boolean":
      return "bool";
...
function Inputs({
  ...
  const disabled = React.useMemo(() => !get__default.default(metadatas, "editable", true), [metadatas]);
  const { type, customField: customFieldUid } = fieldSchema;
  const error = get__default.default(formErrors, [keys], null);
  ...
  const isRequired = React.useMemo(() => get__default.default(validations, ["required"], false), [validations]);
  ...
  const shouldDisplayNotAllowedInput = React.useMemo(() => {
...
Inputs.propTypes = {
  allowedFields: PropTypes__default.default.array.isRequired,
  componentUid: PropTypes__default.default.string,
  fieldSchema: PropTypes__default.default.object.isRequired,
  formErrors: PropTypes__default.default.object,
  keys: PropTypes__default.default.string.isRequired,
  isCreatingEntry: PropTypes__default.default.bool.isRequired,
  labelAction: PropTypes__default.default.element,
  metadatas: PropTypes__default.default.object.isRequired,
  onChange: PropTypes__default.default.func.isRequired,
  readableFields: PropTypes__default.default.array.isRequired,
  size: PropTypes__default.default.number,
  shouldNotRunValidations: PropTypes__default.default.bool.isRequired,
  value: PropTypes__default.default.any,
  queryInfos: PropTypes__default.default.shape({
    containsKey: PropTypes__default.default.string,
    defaultParams: PropTypes__default.default.object,
    endPoint: PropTypes__default.default.string
  }),
  customFieldInputs: PropTypes__default.default.object
};
const getStep = (type) => {
  switch (type) {
    case "float":
...
const Memoized$3 = React.memo(Inputs, isEqual__default.default);
...
const NonRepeatableComponent = ({ componentUid, isFromDynamicZone, isNested, name }) => {
  ...
  const componentLayoutData = React.useMemo(
...
NonRepeatableComponent.propTypes = {
  ...
  isNested: PropTypes__default.default.bool,
  name: PropTypes__default.default.string.isRequired
};
const Footer = styled__default.default(designSystem.Box)`
  overflow: hidden;
...
`;
const Content = styled__default.default(designSystem.Box)`
  border-bottom: none;
...
`;
const Preview$1 = () => {
  return /* @__PURE__ */ jsxRuntime.jsx(StyledSpan, { padding: 6, background: "primary100" });
};
...
const DraggedItem = ({
  ...
  const [{ handlerId, isDragging, handleKeyDown }, boxRef, dropRef, dragRef, dragPreviewRef] = schema.useDragAndDrop(!isReadOnly, {
  ...
  const composedAccordionRefs = schema.composeRefs(accordionRef, dragRef);
  const composedBoxRefs = schema.composeRefs(boxRef, dropRef);
  const { lazyComponentStore } = useLazyComponents();
  return /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { ref: composedBoxRefs, children: isDragging ? /* @__PURE__ */ jsxRuntime.jsx(Preview$1, {}) : /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Accordion, { expanded: isOpen, onToggle: onClickToggle, id: componentFieldName, size: "S", children: [
    /* @__PURE__ */ jsxRuntime.jsx(
      designSystem.AccordionToggle,
      {
        action: isReadOnly ? null : /* @__PURE__ */ jsxRuntime.jsxs(ActionsFlex$1, { gap: 0, expanded: isOpen, children: [
          /* @__PURE__ */ jsxRuntime.jsx(
            CustomIconButton,
            {
              ...
              label: formatMessage({
                id: schema.getTrad("containers.Edit.delete"),
                defaultMessage: "Delete"
              }),
              icon: /* @__PURE__ */ jsxRuntime.jsx(Icons.Trash, {})
            }
          ...
          /* @__PURE__ */ jsxRuntime.jsx(
            designSystem.IconButton,
            {
              ...
              "data-handler-id": handlerId,
              label: formatMessage({
                id: schema.getTrad("components.DragHandle-label"),
                defaultMessage: "Drag"
              }),
              onKeyDown: handleKeyDown,
              children: /* @__PURE__ */ jsxRuntime.jsx(Icons.Drag, {})
    ...
    /* @__PURE__ */ jsxRuntime.jsx(designSystem.AccordionContent, { children: /* @__PURE__ */ jsxRuntime.jsx(
      designSystem.Flex,
      {
        ...
        children: fields.map((fieldRow, key) => {
          return (
            // eslint-disable-next-line react/no-array-index-key
            /* @__PURE__ */ jsxRuntime.jsx(designSystem.Grid, { gap: 4, children: fieldRow.map(({ name, fieldSchema, metadatas, queryInfos, size: size2 }) => {
              const isComponent = fieldSchema.type === "component";
...
DraggedItem.propTypes = {
  componentFieldName: PropTypes__default.default.string.isRequired,
  componentUid: PropTypes__default.default.string,
  fields: PropTypes__default.default.array,
  index: PropTypes__default.default.number.isRequired,
  isOpen: PropTypes__default.default.bool,
  isReadOnly: PropTypes__default.default.bool,
  mainField: PropTypes__default.default.string.isRequired,
  moveComponentField: PropTypes__default.default.func.isRequired,
  onGrabItem: PropTypes__default.default.func,
  onDropItem: PropTypes__default.default.func,
  onCancel: PropTypes__default.default.func,
  onClickToggle: PropTypes__default.default.func.isRequired,
  toggleCollapses: PropTypes__default.default.func
};
const Component = React.memo(DraggedItem);
...
const RepeatableComponent = ({
  ...
  const componentTmpKeyWithFocussedField = React.useMemo(() => {
    if (search.has("field")) {
      ...
      if (get__default.default(componentValue, path, void 0) !== void 0) {
        ...
        return get__default.default(componentValue, subpaths[0], void 0)?.__temp_key__;
      }
    }
    return void 0;
  ...
  const nextTempKey = React.useMemo(() => getMaxTempKey(componentValue || []) + 1, [componentValue]);
  const componentErrorKeys = getComponentErrorKeys(name, formErrors);
  const missingComponentsValue = min - componentValueLength;
  const hasMinError = get__default.default(formErrors, name, { id: "" }).id.includes("min");
  ...
  const handleClick = () => {
    if (!isReadOnly) {
      if (componentValueLength < max) {
        ...
        toggleNotification({
          type: "info",
          message: { id: schema.getTrad("components.notification.info.maximum-requirement") }
        });
      }
    }
  };
  ...
  const mainField = get__default.default(componentLayoutData, ["settings", "mainField"], "id");
  ...
  if (hasMinError) {
    errorMessage = {
      id: schema.getTrad("components.DynamicZone.missing-components"),
    ...
    errorMessage = {
      id: schema.getTrad("components.RepeatableComponent.error-message"),
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Box, { hasRadius: true, children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsx(designSystem.VisuallyHidden, { "aria-live": "assertive", children: liveText }),
    /* @__PURE__ */ jsxRuntime.jsxs(Group, { error: errorMessage, ariaDescribedBy: ariaDescriptionId, children: [
      /* @__PURE__ */ jsxRuntime.jsx(Content, { "aria-describedby": ariaDescriptionId, children: componentValue.map(({ __temp_key__: key }, index2) => /* @__PURE__ */ jsxRuntime.jsx(
        Component,
        {
      ...
      /* @__PURE__ */ jsxRuntime.jsx(Footer, { children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Flex, { justifyContent: "center", height: "48px", background: "neutral0", children: /* @__PURE__ */ jsxRuntime.jsx(TextButtonCustom, { disabled: isReadOnly, onClick: handleClick, startIcon: /* @__PURE__ */ jsxRuntime.jsx(Icons.Plus, {}), children: formatMessage({
        id: schema.getTrad("containers.EditView.add.new-entry"),
...
RepeatableComponent.propTypes = {
  componentUid: PropTypes__default.default.string.isRequired,
  componentValue: PropTypes__default.default.oneOfType([PropTypes__default.default.array, PropTypes__default.default.object]),
  componentValueLength: PropTypes__default.default.number,
  isReadOnly: PropTypes__default.default.bool,
  max: PropTypes__default.default.number,
  min: PropTypes__default.default.number,
  name: PropTypes__default.default.string.isRequired
};
const RepeatableComponent$1 = React.memo(RepeatableComponent);
...
const Label = ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { paddingBottom: 1, children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { children: [
    /* @__PURE__ */ jsxRuntime.jsxs(
      designSystem.Typography,
      {
        ...
        children: [
          label,
          showNumberOfEntries && /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
            " (",
            numberOfEntries,
            ")"
          ] }),
...
Label.propTypes = {
  ...
  labelAction: PropTypes__default.default.element,
  name: PropTypes__default.default.string.isRequired,
  numberOfEntries: PropTypes__default.default.number,
  required: PropTypes__default.default.bool,
  showNumberOfEntries: PropTypes__default.default.bool
};
...
function useSelect$3({ isFromDynamicZone, name }) {
  ...
  const allDynamicZoneFields = React.useMemo(() => {
    const attributes = get__default.default(contentType, ["attributes"], {});
    const dynamicZoneFields = Object.keys(attributes).filter((attrName) => {
      return get__default.default(attributes, [attrName, "type"], "") === "dynamiczone";
    });
  ...
  const componentValue = get__default.default(modifiedData, name, null);
  const compoName = React.useMemo(() => {
  ...
  const hasChildrenAllowedFields = React.useMemo(() => {
    ...
    const relatedChildrenAllowedFields = allowedFields.map((fieldName) => {
      ...
      const joined = take__default.default(fieldName, compoName.length).join(".");
...
const FieldComponent = ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Box, { children: [
    /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { justifyContent: "space-between", children: [
      intlLabel && /* @__PURE__ */ jsxRuntime.jsx(
        Label,
        {
          intlLabel,
          labelAction,
      ...
      showResetComponent && /* @__PURE__ */ jsxRuntime.jsx(
        ...
        {
          label: formatMessage({
            id: schema.getTrad("components.reset-entry"),
...
FieldComponent.propTypes = {
  addNonRepeatableComponentToField: PropTypes__default.default.func.isRequired,
  componentUid: PropTypes__default.default.string.isRequired,
  componentValue: PropTypes__default.default.oneOfType([PropTypes__default.default.object, PropTypes__default.default.array]),
  hasChildrenAllowedFields: PropTypes__default.default.bool,
  hasChildrenReadableFields: PropTypes__default.default.bool,
  isCreatingEntry: PropTypes__default.default.bool.isRequired,
  isFromDynamicZone: PropTypes__default.default.bool,
  isReadOnly: PropTypes__default.default.bool,
  isRepeatable: PropTypes__default.default.bool,
  isNested: PropTypes__default.default.bool,
  intlLabel: PropTypes__default.default.shape({
    id: PropTypes__default.default.string.isRequired,
    defaultMessage: PropTypes__default.default.string.isRequired,
  ...
  min: PropTypes__default.default.number,
  name: PropTypes__default.default.string.isRequired,
  removeComponentFromField: PropTypes__default.default.func.isRequired,
  required: PropTypes__default.default.bool
};
const Memoized$2 = React.memo(FieldComponent, isEqual__default.default);
...
const DynamicComponent = ({
  ...
  const { icon, friendlyName, mainValue } = React.useMemo(() => {
    ...
    const mainField = get__default.default(modifiedData, [name, index2, mainFieldKey]) ?? "";
  ...
  if (fieldsErrors.length > 0) {
    errorMessage = formatMessage({
      id: schema.getTrad("components.DynamicZone.error-message"),
  ...
  const [{ handlerId, isDragging, handleKeyDown }, boxRef, dropRef, dragRef, dragPreviewRef] = schema.useDragAndDrop(isFieldAllowed, {
  ...
  const composedBoxRefs = schema.composeRefs(boxRef, dropRef);
  const accordionActions = !isFieldAllowed ? null : /* @__PURE__ */ jsxRuntime.jsxs(ActionsFlex, { gap: 0, expanded: isOpen, children: [
    /* @__PURE__ */ jsxRuntime.jsx(
      IconButtonCustom,
      {
        noBorder: true,
        label: formatMessage(
          {
            id: schema.getTrad("components.DynamicZone.delete-label"),
    ...
    /* @__PURE__ */ jsxRuntime.jsxs(v2.Menu.Root, { children: [
      /* @__PURE__ */ jsxRuntime.jsxs(v2.Menu.Trigger, { size: "S", endIcon: null, paddingLeft: 2, paddingRight: 2, children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsx(designSystem.VisuallyHidden, { as: "span", children: formatMessage({
          id: schema.getTrad("components.DynamicZone.more-actions"),
      ...
      /* @__PURE__ */ jsxRuntime.jsxs(v2.Menu.Content, { children: [
        /* @__PURE__ */ jsxRuntime.jsxs(v2.Menu.SubRoot, { children: [
          /* @__PURE__ */ jsxRuntime.jsx(v2.Menu.SubTrigger, { children: formatMessage({
            id: schema.getTrad("components.DynamicZone.add-item-above"),
            defaultMessage: "Add component above"
          }) }),
          /* @__PURE__ */ jsxRuntime.jsx(v2.Menu.SubContent, { children: Object.entries(dynamicComponentsByCategory).map(([category, components]) => /* @__PURE__ */ jsxRuntime.jsxs(React__namespace.default.Fragment, { children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsxs(v2.Menu.SubRoot, { children: [
          /* @__PURE__ */ jsxRuntime.jsx(v2.Menu.SubTrigger, { children: formatMessage({
            id: schema.getTrad("components.DynamicZone.add-item-below"),
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(ComponentContainer, { as: "li", width: "100%", children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsx(StyledBox, { ref: composedBoxRefs, hasRadius: true, children: isDragging ? /* @__PURE__ */ jsxRuntime.jsx(Preview, { padding: 6, background: "primary100" }) : /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Accordion, { expanded: isOpen, onToggle: handleToggle, size: "S", error: errorMessage, children: [
      /* @__PURE__ */ jsxRuntime.jsx(
        designSystem.AccordionToggle,
        {
...
DynamicComponent.propTypes = {
  ...
  onDropItem: PropTypes__default.default.func,
  onCancel: PropTypes__default.default.func,
  onMoveComponent: PropTypes__default.default.func.isRequired,
  onRemoveComponentClick: PropTypes__default.default.func.isRequired
};
...
DynamicZoneLabel.propTypes = {
  ...
  labelAction: PropTypes__default.default.element,
  name: PropTypes__default.default.string.isRequired,
  numberOfComponents: PropTypes__default.default.number,
  required: PropTypes__default.default.bool
};
const DynamicZone = ({ name, labelAction, fieldSchema, metadatas }) => {
  ...
  const renderButtonLabel = () => {
    ...
    return formatMessage(
      {
        id: schema.getTrad("components.DynamicZone.add-component"),
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { direction: "column", alignItems: "stretch", gap: 6, children: [
    dynamicDisplayedComponentsLength > 0 && /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Box, { children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.VisuallyHidden, { "aria-live": "assertive", children: liveText }),
      /* @__PURE__ */ jsxRuntime.jsx("ol", { "aria-describedby": ariaDescriptionId, children: dynamicDisplayedComponents.map(({ componentUid, id }, index2) => /* @__PURE__ */ jsxRuntime.jsx(
        DynamicComponent,
        {
          componentUid,
          formErrors,
...
const cleanData = ({ browserState, serverState }, currentSchema, componentsSchema) => {
  ...
  const getType = (schema2, attrName) => get__default.default(schema2, ["attributes", attrName, "type"], "");
  const getOtherInfos = (schema2, arr) => get__default.default(schema2, ["attributes", ...arr], "");
  const recursiveCleanData = (browserState2, serverState2, schema2, pathToParent) => {
    return Object.keys(browserState2).reduce((acc, current) => {
      ...
      const attrType = getType(schema2, current);
      const value = get__default.default(browserState2, current);
      const oldValue = get__default.default(serverState2, current);
      const component = getOtherInfos(schema2, [current, "component"]);
      const isRepeatable = getOtherInfos(schema2, [current, "repeatable"]);
      let cleanedData;
      switch (attrType) {
        case "json":
        ...
        case "media":
          if (getOtherInfos(schema2, [current, "multiple"]) === true) {
        ...
        case "relation": {
          ...
          let actualOldValue = get__default.default(rootServerState, trueInitialDataPath, []);
...
const EditViewDataManagerProvider = ({
  ...
  const [isSaving, setIsSaving] = React__namespace.default.useState(false);
  const [reducerState, dispatch] = React.useReducer(reducer$1, initialState$1);
  const {
    formErrors,
    initialData,
    modifiedData,
  ...
  const { setModifiedDataOnly } = reactRedux.useSelector(selectCrudReducer);
  const reduxDispatch = reactRedux.useDispatch();
  const toggleNotification = helperPlugin.useNotification();
  const { lockApp, unlockApp } = helperPlugin.useOverlayBlocker();
  const currentContentTypeLayout = get__default.default(allLayoutData, ["contentType"], {});
  ...
  const relationConnect = React.useCallback(({ name, value, toOneRelation }) => {
    dispatch({
  ...
  const checkFormErrors = React.useCallback(
    async (dataToSet = {}) => {
      ...
      if (!isEmpty__default.default(updatedData)) {
  ...
  const handleSubmit = React.useCallback(
    async (e) => {
      ...
      try {
        ...
        errors = {
          ...errors,
          ...helperPlugin.getAPIInnerErrors(err, { getTrad: schema.getTrad })
        };
      }
      dispatch({
        type: "SET_FORM_ERRORS",
  ...
  const handlePublish = React.useCallback(async () => {
    const schema$1 = schema.createYupSchema(
      currentContentTypeLayout,
      {
    ...
    let errors = {};
    try {
      await schema$1.validate(modifiedData, { abortEarly: false });
    } catch (err) {
      errors = helperPlugin.getYupInnerErrors(err);
    }
    try {
  ...
  const moveComponentField = React.useCallback(({ name, newIndex, currentIndex }) => {
    dispatch({
  ...
  const relationReorder = React.useCallback(({ name, oldIndex, newIndex }) => {
    dispatch({
  ...
  const removeComponentFromField = React.useCallback((keys, componentUid) => {
    dispatch({
  ...
  const removeRepeatableField = React.useCallback((keys, componentUid) => {
    dispatch({
...
EditViewDataManagerProvider.propTypes = {
  allLayoutData: PropTypes__default.default.object.isRequired,
  allowedActions: PropTypes__default.default.object.isRequired,
  children: PropTypes__default.default.node.isRequired,
  componentsDataStructure: PropTypes__default.default.object.isRequired,
  contentTypeDataStructure: PropTypes__default.default.object.isRequired,
  createActionAllowedFields: PropTypes__default.default.array.isRequired,
  from: PropTypes__default.default.string,
  initialValues: PropTypes__default.default.object,
  isCreatingEntry: PropTypes__default.default.bool.isRequired,
  isLoadingForData: PropTypes__default.default.bool.isRequired,
  isSingleType: PropTypes__default.default.bool.isRequired,
  onPost: PropTypes__default.default.func.isRequired,
  onPublish: PropTypes__default.default.func.isRequired,
  onDraftRelationCheck: PropTypes__default.default.func.isRequired,
  onPut: PropTypes__default.default.func.isRequired,
  onUnpublish: PropTypes__default.default.func.isRequired,
  readActionAllowedFields: PropTypes__default.default.array.isRequired,
  redirectToPreviousPage: PropTypes__default.default.func,
  slug: PropTypes__default.default.string.isRequired,
  status: PropTypes__default.default.string.isRequired,
  updateActionAllowedFields: PropTypes__default.default.array.isRequired
};
...
SingleTypeFormWrapper.propTypes = {
  allLayoutData: PropTypes__default.default.shape({
    components: PropTypes__default.default.object.isRequired,
    contentType: PropTypes__default.default.object.isRequired
  }).isRequired,
  children: PropTypes__default.default.func.isRequired,
  slug: PropTypes__default.default.string.isRequired
};
const SingleTypeFormWrapper$1 = React.memo(SingleTypeFormWrapper);
...
function useSelect$2() {
  ...
  let trackerProperty = {};
  if (hasDraftAndPublish) {
    const isDraft = isEmpty__default.default(modifiedData.publishedAt);
...
const DeleteLink = ({ onDelete, trackerProperty }) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
    /* @__PURE__ */ jsxRuntime.jsx(designSystem.Button, { onClick: toggleWarningDelete, size: "S", startIcon: /* @__PURE__ */ jsxRuntime.jsx(Icons.Trash, {}), variant: "danger-light", children: formatMessage({
      id: schema.getTrad("containers.Edit.delete-entry"),
...
DeleteLink.propTypes = {
  ...
  trackerProperty: PropTypes__default.default.object.isRequired
};
const Memoized$1 = React.memo(DeleteLink, isEqual__default.default);
      ...
      children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Box, { as: designSystem.Flex, children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Box, { paddingLeft: 3, children: [
          /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Typography, { textColor: colorProps.textColor, children: [
            formatMessage({
              id: schema.getTrad("containers.Edit.information.editing"),
          ...
          /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Typography, { fontWeight: "bold", textColor: colorProps.textColor, children: [
            isPublished && formatMessage({
              id: schema.getTrad("containers.Edit.information.publishedVersion"),
              defaultMessage: "published version"
            }),
            !isPublished && formatMessage({
              id: schema.getTrad("containers.Edit.information.draftVersion"),
...
DraftAndPublishBadge.propTypes = {
  hasDraftAndPublish: PropTypes__default.default.bool.isRequired,
  isPublished: PropTypes__default.default.bool.isRequired
};
const DraftAndPublishBadge$1 = connect$1(DraftAndPublishBadge, useSelect$1);
const GridRow = ({ columns, customFieldInputs }) => {
  return /* @__PURE__ */ jsxRuntime.jsx(designSystem.Grid, { gap: 4, children: columns.map(({ fieldSchema, labelAction, metadatas, name, size: size2, queryInfos }) => {
    const isComponent = fieldSchema.type === "component";
    if (isComponent) {
...
const FlexTextAlign = styled__default.default(designSystem.Flex)`
  text-align: center;
`;
const Header = ({
  ...
  const didChangeData = !isEqual__default.default(initialData, modifiedData) || isCreatingEntry && !isEmpty__default.default(modifiedData);
  const createEntryIntlTitle = formatMessage({
    id: schema.getTrad("containers.Edit.pluginHeader.title.new"),
  ...
  if (isCreatingEntry && canCreate) {
    primaryAction = /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { gap: 2, children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.Button, { disabled: !didChangeData, loading: status === "submit-pending", type: "submit", children: formatMessage({
        id: schema.getTrad("containers.Edit.submit"),
        defaultMessage: "Save"
      }) })
    ] });
  }
  if (!isCreatingEntry && canUpdate) {
    ...
    const isPublished = !isEmpty__default.default(initialData.publishedAt);
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
        ...
        children: [
          /* @__PURE__ */ jsxRuntime.jsx(designSystem.DialogBody, { icon: /* @__PURE__ */ jsxRuntime.jsx(Icons.ExclamationMarkCircle, {}), children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { direction: "column", alignItems: "stretch", gap: 2, children: [
            /* @__PURE__ */ jsxRuntime.jsx(designSystem.Flex, { justifyContent: "center", style: { textAlign: "center" }, children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { id: "confirm-description", children: formatMessage(
              {
                id: schema.getTrad("popUpWarning.warning.unpublish"),
            ...
            /* @__PURE__ */ jsxRuntime.jsx(designSystem.Flex, { justifyContent: "center", style: { textAlign: "center" }, children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { id: "confirm-description", children: formatMessage({
              id: schema.getTrad("popUpWarning.warning.unpublish-question"),
    ...
    /* @__PURE__ */ jsxRuntime.jsxs(
      designSystem.Dialog,
      {
        ...
        title: formatMessage({
          id: schema.getTrad(`popUpWarning.warning.has-draft-relations.title`),
        ...
        children: [
          /* @__PURE__ */ jsxRuntime.jsx(designSystem.DialogBody, { icon: /* @__PURE__ */ jsxRuntime.jsx(Icons.ExclamationMarkCircle, {}), children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { direction: "column", alignItems: "stretch", gap: 2, children: [
            /* @__PURE__ */ jsxRuntime.jsx(FlexTextAlign, { justifyContent: "center", children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Typography, { id: "confirm-description", children: [
              draftCount,
              formatMessage(
                {
                  id: schema.getTrad(`popUpwarning.warning.has-draft-relations.message`),
            ...
            /* @__PURE__ */ jsxRuntime.jsx(FlexTextAlign, { justifyContent: "center", children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { id: "confirm-description", children: formatMessage({
              id: schema.getTrad("popUpWarning.warning.publish-question"),
          ...
          /* @__PURE__ */ jsxRuntime.jsx(
            designSystem.DialogFooter,
            {
              ...
              endAction: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Button, { variant: "success", onClick: onPublish, children: formatMessage({
                id: schema.getTrad("popUpwarning.warning.has-draft-relations.button-confirm"),
...
Header.propTypes = {
  allowedActions: PropTypes__default.default.shape({
  ...
  initialData: PropTypes__default.default.object.isRequired,
  isCreatingEntry: PropTypes__default.default.bool.isRequired,
  isSingleType: PropTypes__default.default.bool.isRequired,
  status: PropTypes__default.default.string.isRequired,
  layout: PropTypes__default.default.object.isRequired,
  hasDraftAndPublish: PropTypes__default.default.bool.isRequired,
  modifiedData: PropTypes__default.default.object.isRequired,
  onPublish: PropTypes__default.default.func.isRequired,
  onUnpublish: PropTypes__default.default.func.isRequired,
  publishConfirmation: PropTypes__default.default.shape({
    show: PropTypes__default.default.bool.isRequired,
    draftCount: PropTypes__default.default.number.isRequired
  }).isRequired,
  onPublishPromptDismissal: PropTypes__default.default.func.isRequired
};
const Memoized = React.memo(Header, isEqual__default.default);
...
const Title = () => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { direction: "column", alignItems: "stretch", gap: 2, children: [
    /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { variant: "sigma", textColor: "neutral600", id: "additional-information", children: formatMessage({
      id: schema.getTrad("containers.Edit.information"),
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { direction: "column", alignItems: "stretch", gap: 4, children: [
    /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { direction: "column", alignItems: "stretch", gap: 2, as: "dl", children: [
      /* @__PURE__ */ jsxRuntime.jsx(
        ...
        {
          label: formatMessage({
            id: schema.getTrad("containers.Edit.information.created"),
      ...
      /* @__PURE__ */ jsxRuntime.jsx(
        ...
        {
          label: formatMessage({
            id: schema.getTrad("containers.Edit.information.by"),
            defaultMessage: "By"
          }),
          value: created.by
        }
    ...
    /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { direction: "column", alignItems: "stretch", gap: 2, as: "dl", children: [
      /* @__PURE__ */ jsxRuntime.jsx(
        ...
        {
          label: formatMessage({
            id: schema.getTrad("containers.Edit.information.lastUpdate"),
...
const createAttributesLayout = (currentContentTypeLayoutData) => {
  ...
  const getType = (name) => get__default.default(attributes, [name, "type"], "");
  ...
  currentLayout.forEach((row) => {
    ...
    if (hasDynamicZone) {
      currentRowIndex = currentRowIndex === 0 && isEmpty__default.default(newLayout[0]) ? 0 : currentRowIndex + 1;
      if (!newLayout[currentRowIndex]) {
        newLayout[currentRowIndex] = [];
      }
...
const getFieldsActionMatchingPermissions = (userPermissions, slug) => {
  const getMatchingPermissions = (action) => {
    ...
    return uniq__default.default(flatMap__default.default(matched, "properties.fields"));
  };
  return {
...
const EditView = ({ allowedActions, isSingleType, goBack, slug, id, origin, userPermissions }) => {
  const { trackUsage } = helperPlugin.useTracking();
  const { formatMessage } = reactIntl.useIntl();
  const permissions2 = reactRedux.useSelector(AuthenticatedApp.selectAdminPermissions);
  const location = reactRouterDom.useLocation();
  const toggleNotification = helperPlugin.useNotification();
  const Information2 = index$2.useEnterprise(
    InformationBoxCE,
    async () => (await Promise.resolve().then(() => require("./index-02f58272.js"))).InformationBoxEE
  );
  useOnce(() => {
  ...
  const { layout, formattedContentTypeLayout, customFieldUids } = reactRedux.useSelector((state) => ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(DataManagementWrapper, { allLayoutData: layout, slug, id, origin, children: ({
    componentsDataStructure,
    contentTypeDataStructure,
    data,
    isCreatingEntry,
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(
      EditViewDataManagerProvider,
      {
        ...
        children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Main, { "aria-busy": status !== "resolved", children: [
          /* @__PURE__ */ jsxRuntime.jsx(Header$1, { allowedActions }),
          /* @__PURE__ */ jsxRuntime.jsx(designSystem.ContentLayout, { children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Grid, { gap: 4, children: [
            /* @__PURE__ */ jsxRuntime.jsx(designSystem.GridItem, { col: 9, s: 12, children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Flex, { direction: "column", alignItems: "stretch", gap: 6, children: formattedContentTypeLayout.map((row, index2) => {
              ...
              return /* @__PURE__ */ jsxRuntime.jsx(
                designSystem.Box,
                {
                  ...
                  paddingBottom: 6,
                  borderColor: "neutral150",
                  children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Flex, { direction: "column", alignItems: "stretch", gap: 6, children: row.map((grid, gridRowIndex) => /* @__PURE__ */ jsxRuntime.jsx(
                    GridRow,
                    {
                      columns: grid,
                      customFieldInputs: lazyComponentStore
            ...
            /* @__PURE__ */ jsxRuntime.jsx(designSystem.GridItem, { col: 3, s: 12, children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { direction: "column", alignItems: "stretch", gap: 2, children: [
              /* @__PURE__ */ jsxRuntime.jsx(DraftAndPublishBadge$1, {}),
              /* @__PURE__ */ jsxRuntime.jsxs(
                designSystem.Box,
                {
                  as: "aside",
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntime.jsx(index$2.InjectionZone, { area: "contentManager.editView.informations" })
                  ]
                }
              ),
              /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { as: "aside", "aria-labelledby": "links", children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { direction: "column", alignItems: "stretch", gap: 2, children: [
                /* @__PURE__ */ jsxRuntime.jsx(index$2.InjectionZone, { area: "contentManager.editView.right-links", slug }),
                ...
                allowedActions.canDelete && !isCreatingEntry && /* @__PURE__ */ jsxRuntime.jsx(DeleteLink$1, { onDelete })
              ] }) })
            ] }) })
          ] }) })
        ] })
...
EditView.propTypes = {
  ...
  origin: PropTypes__default.default.string,
  slug: PropTypes__default.default.string.isRequired,
  userPermissions: PropTypes__default.default.array
};
const Permissions$2 = (props) => {
  const viewPermissions = React.useMemo(() => generatePermissionsObject(props.slug), [props.slug]);
  const { isLoading, allowedActions } = helperPlugin.useRBAC(viewPermissions, props.userPermissions);
  if (isLoading) {
    return /* @__PURE__ */ jsxRuntime.jsx(helperPlugin.LoadingIndicatorPage, {});
  }
  return /* @__PURE__ */ jsxRuntime.jsx(EditView, { ...props, allowedActions });
};
...
Permissions$2.propTypes = {
  ...
  slug: PropTypes__default.default.string.isRequired,
  userPermissions: PropTypes__default.default.array.isRequired
};
const Permissions$3 = React.memo(Permissions$2, isEqual__default.default);
const { MUTATE_EDIT_VIEW_LAYOUT } = index$2.HOOKS;
const EditViewLayoutManager = ({ layout, ...rest }) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(Permissions$3, { ...rest, userPermissions: permissions2 });
};
    ...
    /* @__PURE__ */ jsxRuntime.jsx(designSystem.ModalBody, { children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Grid, { gap: 4, children: [
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.GridItem, { s: 12, col: 6, children: /* @__PURE__ */ jsxRuntime.jsx(
        designSystem.TextInput,
        {
          id: "label-input",
          label: formatMessage({
            id: schema.getTrad("form.Input.label"),
          ...
          hint: formatMessage({
            id: schema.getTrad("form.Input.label.inputDescription"),
      ...
      shouldDisplaySortToggle && /* @__PURE__ */ jsxRuntime.jsx(designSystem.GridItem, { s: 12, col: 6, children: /* @__PURE__ */ jsxRuntime.jsx(
        designSystem.ToggleInput,
        {
          ...
          label: formatMessage({
            id: schema.getTrad("form.Input.sort.field"),
...
const Settings = ({
  ...
  const sortOptions = index$2.useEnterprise(
    sortOptionsCE,
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { direction: "column", alignItems: "stretch", gap: 4, children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { justifyContent: "space-between", gap: 4, children: [
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { width: "100%", children: /* @__PURE__ */ jsxRuntime.jsx(
        ...
        {
          label: formatMessage({
            id: schema.getTrad("form.Input.search"),
      ...
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { width: "100%", children: /* @__PURE__ */ jsxRuntime.jsx(
        ...
        {
          label: formatMessage({
            id: schema.getTrad("form.Input.filters"),
      ...
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { width: "100%", children: /* @__PURE__ */ jsxRuntime.jsx(
        ...
        {
          label: formatMessage({
            id: schema.getTrad("form.Input.bulkActions"),
    ...
    /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Grid, { gap: 4, children: [
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.GridItem, { s: 12, col: 6, children: /* @__PURE__ */ jsxRuntime.jsx(
        ...
        {
          label: formatMessage({
            id: schema.getTrad("form.Input.pageEntries"),
            defaultMessage: "Entries per page"
          }),
          hint: formatMessage({
            id: schema.getTrad("form.Input.pageEntries.inputDescription"),
      ...
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.GridItem, { s: 12, col: 3, children: /* @__PURE__ */ jsxRuntime.jsx(
        ...
        {
          label: formatMessage({
            id: schema.getTrad("form.Input.defaultSort"),
      ...
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.GridItem, { s: 12, col: 3, children: /* @__PURE__ */ jsxRuntime.jsx(
        ...
        {
          label: formatMessage({
            id: schema.getTrad("form.Input.sort.order"),
...
`;
const DragButton$1 = styled__default.default(ActionBox)`
    ...
    FieldContainer$1,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { gap: 3, children: [
          /* @__PURE__ */ jsxRuntime.jsx(DragButton$1, { alignItems: "center", cursor: "all-scroll", padding: 3, children: /* @__PURE__ */ jsxRuntime.jsx(Icons.Drag, {}) }),
          /* @__PURE__ */ jsxRuntime.jsx(
...
CardDragPreview.propTypes = {
  isSibling: PropTypes__default.default.bool,
...
const DraggableCard = ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(FieldWrapper, { ref: refs ? refs.dropRef : null, children: [
    isDragging && /* @__PURE__ */ jsxRuntime.jsx(CardDragPreview, { transparent: true, labelField }),
          ...
          /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { gap: 3, children: [
            /* @__PURE__ */ jsxRuntime.jsx(
              DragButton,
              {
                ...
                "aria-label": formatMessage(
                  {
                    id: schema.getTrad("components.DraggableCard.move.field"),
          ...
          /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { paddingLeft: 3, children: [
            /* @__PURE__ */ jsxRuntime.jsx(
              ActionButton,
              {
                ...
                "aria-label": formatMessage(
                  {
                    id: schema.getTrad("components.DraggableCard.edit.field"),
            ...
            /* @__PURE__ */ jsxRuntime.jsx(
              ActionButton,
              {
                ...
                "aria-label": formatMessage(
                  {
                    id: schema.getTrad("components.DraggableCard.delete.field"),
...
const SortDisplayedFields = ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { alignItems: "stretch", direction: "column", gap: 4, children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { padding: 4, borderColor: "neutral300", borderStyle: "dashed", borderWidth: "1px", hasRadius: true, children: [
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { flex: "1", overflow: "scroll hidden", ref: scrollableContainerRef, children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Flex, { gap: 3, children: displayedFields.map((field, index2) => /* @__PURE__ */ jsxRuntime.jsx(
        DraggableCard,
        {
          index: index2,
          isDraggingSibling,
      ...
      /* @__PURE__ */ jsxRuntime.jsxs(v2.Menu.Root, { children: [
        /* @__PURE__ */ jsxRuntime.jsxs(
          v2.Menu.Trigger,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntime.jsx(designSystem.VisuallyHidden, { as: "span", children: formatMessage({
                id: schema.getTrad("components.FieldSelect.label"),
...
const ListSettingsView = ({ layout, slug }) => {
  ...
  const handleRemoveField = (e, index2) => {
    ...
    if (displayedFields.length === 1) {
      toggleNotification({
        type: "info",
        message: { id: schema.getTrad("notification.info.minimumFields") }
      });
    } else {
      dispatch({
        type: "REMOVE_FIELD",
    ...
    /* @__PURE__ */ jsxRuntime.jsxs("form", { onSubmit: handleSubmit, children: [
      /* @__PURE__ */ jsxRuntime.jsx(
        designSystem.HeaderLayout,
        {
          ...
          subtitle: formatMessage({
            id: schema.getTrad("components.SettingsViewWrapper.pluginHeader.description.list-settings"),
...
const getData = () => ({ type: index$2.GET_DATA$1 });
const getDataSucceeded = (pagination, data) => ({
  type: index$2.GET_DATA_SUCCEEDED$1,
  pagination,
  data
});
const onResetListHeaders = () => ({ type: index$2.ON_RESET_LIST_HEADERS });
function resetProps() {
  return { type: index$2.RESET_PROPS$2 };
}
const setLayout = ({ components, contentType }) => {
  ...
  return {
    ...
    type: index$2.SET_LIST_LAYOUT
  };
};
const onChangeListHeaders = (target) => ({ type: index$2.ON_CHANGE_LIST_HEADERS, target });
...
const AdminUsersFilter = ({ value, onChange }) => {
  const { formatMessage } = reactIntl.useIntl();
  const { users, isLoading } = useAdminUsers.useAdminUsers();
  return /* @__PURE__ */ jsxRuntime.jsx(
    designSystem.Combobox,
    {
      value,
...
const InjectionZoneList = ({ area, ...props }) => {
  const compos = index$2.useInjectionZone(area);
  if (!compos) {
    return null;
  }
...
const listViewDomain = () => (state) => state["content-manager_listView"] || index$2.initialState;
      ...
      dialogBody: /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
        /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Typography, { id: "confirm-description", textAlign: "center", children: [
          countDraftRelations > 0 && formatMessage(
            {
              id: schema.getTrad(`popUpwarning.warning.bulk-has-draft-relations.message`),
          ...
          formatMessage({
            id: schema.getTrad("popUpWarning.bodyMessage.contentType.publish.all"),
...
const SelectedEntriesTableContent = ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(helperPlugin.Table.Content, { children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsx(helperPlugin.Table.Body, { children: rowsToDisplay.map((row, index2) => /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Tr, { children: [
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.Td, { children: /* @__PURE__ */ jsxRuntime.jsx(Body.CheckboxDataCell, { rowId: row.id, index: index2 }) }),
...
const SelectedEntriesModalContent = ({
  ...
  const bulkPublishMutation = reactQuery.useMutation(
    (data) => post(`/content-manager/collection-types/${contentType.uid}/actions/bulkPublish`, data),
    {
      ...
      onError(error) {
        toggleNotification({
          type: "warning",
          message: formatAPIErrors.formatAPIErrors(error)
        });
      }
    }
  );
  ...
  const getFormattedCountMessage = () => {
    if (publishedCount) {
      return formatMessage(
        {
          id: schema.getTrad("containers.ListPage.selectedEntriesModal.publishedCount"),
    ...
    return formatMessage(
      {
        id: schema.getTrad("containers.ListPage.selectedEntriesModal.selectedCount"),
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.ModalLayout, { onClose: toggleModal, labelledBy: "title", children: [
    /* @__PURE__ */ jsxRuntime.jsx(designSystem.ModalHeader, { children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { fontWeight: "bold", textColor: "neutral800", as: "h2", id: "title", children: formatMessage({
      id: schema.getTrad("containers.ListPage.selectedEntriesModal.title"),
    ...
    async () => {
      ...
      if (data2.results) {
        ...
        const rows = data2.results.map((entry) => {
          try {
            schema$1.validateSync(entry, { abortEarly: false });
            return entry;
          } catch (e) {
    ...
    ConfirmBulkActionDialog,
    {
      ...
      dialogBody: /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
        /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { id: "confirm-description", textAlign: "center", children: formatMessage({
          id: schema.getTrad("popUpWarning.bodyMessage.contentType.unpublish.all"),
...
const ConfirmDialogDeleteAll = ({ isOpen, onToggleDialog, isConfirmButtonLoading, onConfirm }) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    ConfirmBulkActionDialog,
    {
      ...
      dialogBody: /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
        /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { id: "confirm-description", textAlign: "center", children: formatMessage({
          id: schema.getTrad("popUpWarning.bodyMessage.contentType.delete.all"),
...
const MultipleMedia = ({ value }) => {
  return /* @__PURE__ */ jsxRuntime.jsx(designSystem.AvatarGroup, { children: value.map((file, index2) => {
...
const RelationMultiple = ({ fieldSchema, metadatas, name, entityId, value, contentType }) => {
  ...
  React.useEffect(() => {
    if (data) {
      notifyStatus(
        formatMessage({
          id: schema.getTrad("DynamicTable.relation-loaded"),
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(v2.Menu.Root, { onOpenChange: (isOpen2) => setIsOpen(isOpen2), children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsxs(v2.Menu.Content, { children: [
      status !== "success" && /* @__PURE__ */ jsxRuntime.jsx(v2.Menu.Item, { disabled: true, children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Loader, { small: true, children: formatMessage({
        id: schema.getTrad("ListViewTable.relation-loading"),
        defaultMessage: "Relations are loading"
      }) }) }),
      status === "success" && /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
        ...
        data?.pagination.total > 10 && /* @__PURE__ */ jsxRuntime.jsx(
          v2.Menu.Item,
          {
            "aria-disabled": true,
            "aria-label": formatMessage({
              id: schema.getTrad("ListViewTable.relation-more"),
...
function hasContent(type, content, metadatas, fieldSchema) {
  if (type === "component") {
    ...
    if (schema.isFieldTypeNumber(mainFieldType) && mainFieldType !== "biginteger" && mainFieldName !== "id") {
  ...
  if (schema.isFieldTypeNumber(type) && type !== "biginteger") {
...
const { INJECT_COLUMN_IN_TABLE } = index$2.HOOKS;
...
function ListView({ canCreate, canDelete, canRead, canPublish, layout, slug }) {
  ...
  const { pagination, isLoading, data } = index$2.useTypedSelector(makeSelectListView());
  ...
  const { users, isLoading: isLoadingAdminUsers } = useAdminUsers.useAdminUsers(
  ...
  const reviewWorkflowColumns = index$2.useEnterprise(
    ...
    async () => (await Promise.resolve().then(() => require("./constants-b19fe3c9.js"))).REVIEW_WORKFLOW_COLUMNS_EE,
    {
  ...
  const ReviewWorkflowsColumns = index$2.useEnterprise(
    ...
    async () => {
      const { ReviewWorkflowsStageEE, ReviewWorkflowsAssigneeEE } = await Promise.resolve().then(() => require("./index-c73f17d2.js"));
  ...
  const reviewWorkflowFilter = index$2.useEnterprise(
    ...
    async () => (await Promise.resolve().then(() => require("./constants-45f7751c.js"))).REVIEW_WORKFLOW_FILTERS,
    {
    ...
    async (endPoint, options22) => {
      ...
      try {
        ...
        notifyStatus(
          formatMessage(
            {
              id: schema.getTrad("utils.data-loaded"),
        ...
        toggleNotification({
          type: "warning",
          message: { id: schema.getTrad("error.model.fetch") }
        });
      }
    },
    [
  ...
  const { runHookWaterfall } = helperPlugin.useStrapiApp();
  const displayedHeaders = index$2.useTypedSelector(selectDisplayedHeaders);
  const tableHeaders = React__namespace.useMemo(() => {
      ...
      if (header.fieldSchema.type === "relation") {
        ...
        return {
          ...
          metadatas: {
            ...metadatas2,
            label: formatMessage({
              id: schema.getTrad(`containers.ListPage.table-headers.${header.name}`),
    ...
    if (hasDraftAndPublish) {
      formattedHeaders.push({
        ...
        metadatas: {
          label: formatMessage({
            id: schema.getTrad(`containers.ListPage.table-headers.publishedAt`),
  ...
  const subtitle = canRead ? formatMessage(
    {
      id: schema.getTrad("pages.ListView.header-subtitle"),
  ...
  const getCreateAction = (props) => canCreate ? /* @__PURE__ */ jsxRuntime.jsx(
    designSystem.Button,
    {
      ...
      children: formatMessage({
        id: schema.getTrad("HeaderLayout.button.label-add-entry"),
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Main, { "aria-busy": isLoading, children: [
    ...
    !canRead && /* @__PURE__ */ jsxRuntime.jsx(designSystem.ActionLayout, { endActions: /* @__PURE__ */ jsxRuntime.jsx(index$2.InjectionZone, { area: "contentManager.listView.actions" }) }),
    canRead && /* @__PURE__ */ jsxRuntime.jsx(
      designSystem.ActionLayout,
      {
        endActions: /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
          /* @__PURE__ */ jsxRuntime.jsx(index$2.InjectionZone, { area: "contentManager.listView.actions" }),
            ...
            Body.Root,
            {
              ...
              children: data.map((rowData, index2) => {
                return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Tr, { cursor: "pointer", onClick: handleRowClick(rowData.id), children: [
                  /* @__PURE__ */ jsxRuntime.jsx(designSystem.Td, { children: /* @__PURE__ */ jsxRuntime.jsx(Body.CheckboxDataCell, { rowId: rowData.id, index: index2 }) }),
...
const ErrorFallback = () => {
  return /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { padding: 8, children: /* @__PURE__ */ jsxRuntime.jsx(helperPlugin.AnErrorOccurred, {}) });
};
const CollectionTypeRecursivePath = ({
  ...
  ].map(({ path, comp }) => /* @__PURE__ */ jsxRuntime.jsx(reactRouterDom.Route, { path: `${url}/${path}`, render: (props) => renderRoute(props, comp) }, path));
  return /* @__PURE__ */ jsxRuntime.jsx(reactErrorBoundary.ErrorBoundary, { FallbackComponent: ErrorFallback, children: /* @__PURE__ */ jsxRuntime.jsx(ContentTypeLayout.Provider, { value: layout, children: /* @__PURE__ */ jsxRuntime.jsxs(reactRouterDom.Switch, { children: [
...
CollectionTypeRecursivePath.propTypes = {
  match: PropTypes__default.default.shape({
    url: PropTypes__default.default.string.isRequired,
...
const CollectionTypeRecursivePath$1 = React.memo(CollectionTypeRecursivePath);
const ComponentSettingsView = () => {
  const [{ isLoading, data: layout }, dispatch] = React.useReducer(index$2.crudReducer, index$2.crudInitialState);
  const schemasSelector = React.useMemo(schema.makeSelectModelAndComponentSchemas, []);
  const { schemas } = reactRedux.useSelector((state) => schemasSelector(state), reactRedux.shallowEqual);
  const permissions2 = reactRedux.useSelector(AuthenticatedApp.selectAdminPermissions);
...
const ComponentSettingsView$1 = React.memo(ComponentSettingsView);
const NoContentType = () => {
  const { formatMessage } = reactIntl.useIntl();
  helperPlugin.useFocusWhenNavigate();
...
const SingleTypeRecursivePath = ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(ContentTypeLayout.Provider, { value: layout, children: /* @__PURE__ */ jsxRuntime.jsxs(reactRouterDom.Switch, { children: [
...
const SingleTypeRecursivePath$1 = React.memo(SingleTypeRecursivePath);
    ...
    designSystem.Flex,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { gap: 2, children: [
          /* @__PURE__ */ jsxRuntime.jsx(designSystem.IconButton, { noBorder: true, children: /* @__PURE__ */ jsxRuntime.jsx(Icons.Trash, {}) }),
          /* @__PURE__ */ jsxRuntime.jsx(designSystem.IconButton, { noBorder: true, children: /* @__PURE__ */ jsxRuntime.jsx(Icons.Drag, {}) })
        ] })
      ]
    }
  );
...
ComponentDragPreview.propTypes = {
  displayedValue: PropTypes__default.default.string.isRequired
};
      ...
      children: [
        /* @__PURE__ */ jsxRuntime.jsxs(FlexWrapper, { gap: 1, children: [
          ...
          /* @__PURE__ */ jsxRuntime.jsxs(ChildrenWrapper, { maxWidth: "100%", justifyContent: "space-between", children: [
            /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { minWidth: 0, paddingTop: 1, paddingBottom: 1, paddingRight: 4, children: /* @__PURE__ */ jsxRuntime.jsx(LinkEllipsis, { children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { textColor: "primary600", ellipsis: true, children: displayedValue }) }) }),
...
const LeftMenu = () => {
  ...
  const { formatMessage, locale } = reactIntl.useIntl();
  const modelLinksSelector = React.useMemo(schema.makeSelectModelLinks, []);
  const { collectionTypeLinks, singleTypeLinks } = reactRedux.useSelector(modelLinksSelector, reactRedux.shallowEqual);
    ...
    () => [
      {
        id: "collectionTypes",
        title: {
          id: schema.getTrad("components.LeftMenu.collection-types"),
      ...
      },
      {
        id: "singleTypes",
        title: {
          id: schema.getTrad("components.LeftMenu.single-types"),
      ...
      return /* @__PURE__ */ jsxRuntime.jsx(
        v2.SubNavSection,
        {
          ...
          children: section.links.map((link) => {
            ...
            return /* @__PURE__ */ jsxRuntime.jsx(v2.SubNavLink, { as: reactRouterDom.NavLink, to: `${link.to}${search2}`, children: link.title }, link.uid);
          })
        },
        section.id
      );
...
const getInitData = () => ({
  type: index$2.GET_INIT_DATA
});
const resetInitData = () => ({ type: index$2.RESET_INIT_DATA });
const setInitData = ({
...
const checkPermissions = (userPermissions, permissionsToCheck) => permissionsToCheck.map(({ permissions: permissions2 }) => helperPlugin.hasPermissions(userPermissions, permissions2));
...
const generateModelsLinks = (models, modelsConfigurations) => {
  const groupedModels = Object.entries(groupBy__default.default(models, "kind")).map(([key, value]) => ({
    name: key,
    links: value
  }));
  const [collectionTypes, singleTypes] = sortBy__default.default(groupedModels, "name");
  return {
...
const { MUTATE_COLLECTION_TYPES_LINKS, MUTATE_SINGLE_TYPES_LINKS } = index$2.HOOKS;
const useContentManagerInitData = () => {
  const dispatch = reactRedux.useDispatch();
  const toggleNotification = helperPlugin.useNotification();
  const state = reactRedux.useSelector(schema.selectAppDomain());
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      notifyStatus(
        formatMessage({
          id: schema.getTrad("App.schemas.data-loaded"),
...
const App = () => {
  ...
  const authorisedModels = sortBy__default.default(
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Layout, { sideNav: /* @__PURE__ */ jsxRuntime.jsx(LeftMenu, {}), children: [
    /* @__PURE__ */ jsxRuntime.jsx(DragLayer.DragLayer, { renderItem: renderDraglayerItem }),
    /* @__PURE__ */ jsxRuntime.jsx(ModelsContext.Provider, { value: { refetchData }, children: /* @__PURE__ */ jsxRuntime.jsxs(reactRouterDom.Switch, { children: [
      /* @__PURE__ */ jsxRuntime.jsx(reactRouterDom.Route, { path: "/content-manager/components/:uid/configurations/edit", children: /* @__PURE__ */ jsxRuntime.jsx(helperPlugin.CheckPagePermissions, { permissions: permissions2.contentManager.componentsConfigurations, children: /* @__PURE__ */ jsxRuntime.jsx(ComponentSettingsView$1, {}) }) }),
      /* @__PURE__ */ jsxRuntime.jsx(
        reactRouterDom.Route,
        {
      ...
      /* @__PURE__ */ jsxRuntime.jsx(reactRouterDom.Route, { path: "/content-manager/singleType/:slug", component: SingleTypeRecursivePath$1 }),
...
function index() {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
    /* @__PURE__ */ jsxRuntime.jsx(
      reactHelmet.Helmet,
      {
        title: formatMessage({ id: schema.getTrad("plugin.name"), defaultMessage: "Content Manager" })
      }
    ),
    /* @__PURE__ */ jsxRuntime.jsx(App, {})
  ] });
}
...
//# sourceMappingURL=index-c7f06c75.js.map
