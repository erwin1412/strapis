...
const ProtectedApiTokenListView = () => {
  const permissions = useSelector(selectAdminPermissions);
  return /* @__PURE__ */ jsx(CheckPagePermissions, { permissions: permissions.settings["api-tokens"].main, children: /* @__PURE__ */ jsx(ApiTokenListView, {}) });
};
export {
  ProtectedApiTokenListView as default
};
//# sourceMappingURL=index-a4d005f4.mjs.map
