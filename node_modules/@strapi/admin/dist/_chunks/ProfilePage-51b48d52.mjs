...
import { M as useLocales, P as useThemeToggle } from "./index-4c3eb885.mjs";
import { g as getFullName } from "./AuthenticatedApp-5524c90a.mjs";
...
const ProfilePage = () => {
  ...
  const submitMutation = useMutation(
    async (body) => {
      const { confirmPassword: _confirmPassword, currentTheme: currentTheme2, ...dataToSend } = body;
...
//# sourceMappingURL=ProfilePage-51b48d52.mjs.map
