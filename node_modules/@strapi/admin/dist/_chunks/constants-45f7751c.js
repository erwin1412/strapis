...
const index = require("./index-c7f06c75.js");
...
require("./AuthenticatedApp-96716173.js");
...
require("./useDebounce-4712871e.js");
...
const REVIEW_WORKFLOW_FILTERS = [
  {
    ...
    metadatas: {
      ...
      label: {
        id: schema.getTrad(`containers.ListPage.table-headers.reviewWorkflows.stage`),
  ...
  },
  {
    ...
    metadatas: {
      ...
      label: {
        id: schema.getTrad(`containers.ListPage.table-headers.reviewWorkflows.assignee.label`),
...
//# sourceMappingURL=constants-45f7751c.js.map
