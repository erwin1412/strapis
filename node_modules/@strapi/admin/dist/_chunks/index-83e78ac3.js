...
const PrivateRoute = ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    ...
    {
      path,
      render: (props) => helperPlugin.auth.getToken() !== null ? /* @__PURE__ */ jsxRuntime.jsx(Component, { ...rest, ...props }) : /* @__PURE__ */ jsxRuntime.jsx(
...
const AuthPage = ({ hasAdmin }) => {
  ...
  const Login$1 = useEnterprise(
    Login,
    async () => (await Promise.resolve().then(() => require("./Login-a9414070.js"))).LoginEE
  );
  const forms = useEnterprise(
    FORMS,
    async () => (await Promise.resolve().then(() => require("./constants-2d656503.js"))).FORMS,
    {
...
const AuthenticatedApp = React__namespace.lazy(
  () => Promise.resolve().then(() => require("./AuthenticatedApp-96716173.js")).then((n) => n.AuthenticatedApp).then((mod) => ({ default: mod.AuthenticatedApp }))
);
const App = () => {
  ...
  const { formatMessage } = reactIntl.useIntl();
  const [{ isLoading, hasAdmin, uuid, deviceId }, setState] = React__namespace.useState({
    isLoading: true,
    deviceId: void 0,
    hasAdmin: false,
    uuid: false
    ...
    const getData = async () => {
      try {
        ...
        updateProjectSettings({
          menuLogo: helperPlugin.prefixFileUrlWithBackendUrl(menuLogo),
          authLogo: helperPlugin.prefixFileUrlWithBackendUrl(authLogo)
        });
        if (uuid2) {
          const {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(React__namespace.Suspense, { fallback: /* @__PURE__ */ jsxRuntime.jsx(helperPlugin.LoadingIndicatorPage, {}), children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsx(helperPlugin.TrackingProvider, { value: trackingInfo, children: /* @__PURE__ */ jsxRuntime.jsxs(reactRouterDom.Switch, { children: [
      authRoutes,
      /* @__PURE__ */ jsxRuntime.jsx(
        reactRouterDom.Route,
        {
...
const ConfigurationProvider = ({
  ...
  const [{ menuLogo, authLogo }, setLogos] = React__namespace.useState({
    menuLogo: null,
    authLogo: null
  });
...
const GuidedTourProvider = ({ children }) => {
  const [{ currentStep, guidedTourState, isGuidedTourVisible, isSkipped }, dispatch] = React__namespace.useReducer(reducer$1, initialState$6, initialiseState);
...
const reducer$1 = (state = initialState$6, action) => produce__default.default(state, (draftState) => {
  switch (action.type) {
...
const RBACReducer = (state = initialState$5, action) => produce__default.default(state, (draftState) => {
  switch (action.type) {
...
const mainReducer = (state = initialState$3, action) => produce__default.default(state, (draftState) => {
  switch (action.type) {
    case GET_INIT_DATA: {
...
const crudReducer = (state = crudInitialState, action) => produce__default.default(state, (draftState) => {
  switch (action.type) {
    case GET_DATA: {
...
const InjectionZone = ({ area, ...props }) => {
  ...
  return components.map((component) => /* @__PURE__ */ jsxRuntime.jsx(component.Component, { ...props }, component.name));
};
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(
      Providers,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntime.jsx(reactRouterDom.BrowserRouter, { basename: getBasename(), children: /* @__PURE__ */ jsxRuntime.jsx(App, {}) })
        ]
      }
    );
  }
}
const renderAdmin = async (mountNode, { plugins }) => {
  if (!mountNode) {
...
exports.CLEAR_SET_MODIFIED_DATA_ONLY = CLEAR_SET_MODIFIED_DATA_ONLY;
exports.Column = Column;
exports.DefaultDocument = DefaultDocument;
exports.GET_DATA = GET_DATA;
exports.GET_DATA$1 = GET_DATA$1;
exports.GET_DATA_SUCCEEDED = GET_DATA_SUCCEEDED;
exports.GET_DATA_SUCCEEDED$1 = GET_DATA_SUCCEEDED$1;
exports.GET_INIT_DATA = GET_INIT_DATA;
exports.HOOKS = HOOKS;
exports.INIT_FORM = INIT_FORM;
...
exports.ON_CHANGE_LIST_HEADERS = ON_CHANGE_LIST_HEADERS;
exports.ON_RESET_LIST_HEADERS = ON_RESET_LIST_HEADERS;
exports.RBACProvider = RBACProvider;
exports.RESET_INIT_DATA = RESET_INIT_DATA;
exports.RESET_PERMISSIONS = RESET_PERMISSIONS;
...
exports.SET_LIST_LAYOUT = SET_LIST_LAYOUT;
exports.SET_PERMISSIONS = SET_PERMISSIONS;
exports.SET_STATUS = SET_STATUS;
exports.SUBMIT_SUCCEEDED = SUBMIT_SUCCEEDED;
...
//# sourceMappingURL=index-83e78ac3.js.map
