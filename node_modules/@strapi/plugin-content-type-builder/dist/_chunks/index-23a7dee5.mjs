...
const ListView$1 = lazy(() => import("./index-2aa9a9e7.mjs"));
const RecursivePath = () => {
...
const ListView = lazy(() => import("./index-2aa9a9e7.mjs"));
const App = () => {
  const { formatMessage } = useIntl();
...
//# sourceMappingURL=index-23a7dee5.mjs.map
